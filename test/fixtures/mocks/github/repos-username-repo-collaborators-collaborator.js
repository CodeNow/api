...
exports.isCollaborator = function (username, repoName, collaborator) {

  var urlPath = '\/repos\/'+username+'\/'+repoName+'\/collaborators\/'+collaborator+'?';
...
exports.notCollaborator = function (username, repoName, collaborator) {
