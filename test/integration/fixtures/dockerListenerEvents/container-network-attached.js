...
var buildContainer = function (contextVersion, user) {
  return createBaseJob(contextVersion.dockerContainer, {
...
var userContainer = function (instance, user) {
  return createBaseJob(instance.container.dockerContainer, {
    'com-docker-swarm-constraints': '[\'org==17654916\',\'node==~ip-10-8-208-53.17654916\']',
    'com-docker-swarm-id': '53cbbace67eedd4e387cb9a0bcd1ee8355c926f0753b31565c8002d065fa5826',
...
function createBaseJob(containerId, labels) {
  return {
    status: 'start',
    time: 1455917802310,
    id: containerId,
