...
describe('201 POST /instances/:id/copy', {timeout:500}, function () {
  var ctx = {};
...
function copyInstanceTests (ctx) {
  describe('parent has env', function() {
    ...
    copyInstanceSpecs(ctx);
  });
  describe('parent has empty env', function() {
    beforeEach(function (done) {
      var body = {
        build: ctx.build.id()
      };
...
function copyInstanceSpecs (ctx) {
  beforeEach(function (done) {
    ctx.expected.parent = ctx.instance.attrs.shortHash;
    done();
  });
  ...
  it('should create an instance', function (done) {
    ctx.instance = ctx.instance.copy(expects.success(201, ctx.expected, done));
  });
  it('should create an instance with a new name', function (done) {
    ...
    ctx.instance = ctx.instance.copy({json:body}, expects.success(201, ctx.expected, done));
  });
  it('should create an instance with a new name and env', function (done) {
    var name = 'ABCDEFGHIJKLMNOPQRSTUVWYXZ_-';
    var env = [
      'FOO=BAR'
    ];
