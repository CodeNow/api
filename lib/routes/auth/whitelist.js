...
var createIntercomCompany = require('middlewares/create-intercom-company')
...
app.post('/auth/whitelist',
  ...
  function (req, res, next) {
    var github = new GithubModel(keypather.get(req, 'sessionUser.accounts.github.accessToken'))
    github.getUserByUsername(req.body.name, function (err, body) {
