 ...
 * @param {Number} req.body.hasCompletedDEmo  - Flag for when the org has completed demo flow
 * @param {Object} res
 *
...
module.exports.updateFlags = function (req, res) {
  ...
  const body = pick(keypather.get(req, 'body'), ['metadata.hasConfirmedSetup', 'metadata.hasAha', 'metadata.hasCompletedDemo', 'prBotEnabled'])
