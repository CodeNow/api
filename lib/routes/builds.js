...
app.post('/builds/:id/actions/build',
  ...
  mw.req('contextVersion.build.started').require()
    ...
    .else( // build has an unbuilt contextVersion
      flow.try(
        timers.create(),
        timers.model.startTimer('routes.builds.actions.build.replaceContextVersion'),
        mw.req().set('origContextVersion', 'contextVersion'),
        runnable.create({}, 'sessionUser'),
        timers.model.startTimer('routes.builds.actions.build.buildCv'),
        ...
        timers.model.stopTimer('routes.builds.actions.build.buildCv'),
        contextVersions.findById('contextVersionId', { 'build.log': false }),
        ...
        timers.model.stopTimer('routes.builds.actions.build.replaceContextVersion')
      ).catch(
