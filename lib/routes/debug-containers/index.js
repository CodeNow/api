...
app.get('/debug-containers',
  ...
  debugContainer.find('query'), function(req, res, next) {
    async.each(
      req.debugcontainers, function(dc, cb) {
...
app.post('/debug-containers',
  ...
  checkFound('instance'), function(req, res, next) {
    // save the owner of the debug container from the instance
    req.body.owner = {
      github: req.instance.owner.github
    };
    next();
  },
  debugContainer.new('body'),
  debugContainer.model.save(), function(req, res, next) {
...
app.delete('/debug-containers/:id',
  ...
  checkFound('debugcontainer', 'Debug Container not found'), function(req, res, next) {
