...
proxy.on('proxyReq', function (proxyReq, req) {
  ...
  console.log('xxxxxx1111', JSON.stringify(req.headers, true, 2))
  ...
  proxyReq.setHeader('host', 'api.github.com:443')
  console.log('xxxxxx2222', JSON.stringify(req.headers, true, 2))
