...
app.get('/:contextId/versions/:id/files',
  ...
  function (req, res, next) {
    ...
    infraCodeVersion.findDirContents(dirPath, function (err, contents) {
 ...
 *  @memberof module:rest/contexts/versions/files */
app.get('/:contextId/versions/:id/files/:fullpath*',
  function (req, res, next) {
    req.params.fullpath = req.path.replace(
      '/' + req.params.contextId + '/versions/' + req.params.id + '/files/', '');
    next();
  },
  findContextGet,
  findVersion,
 ...
 *  @memberof module:rest/contexts/versions/files */
app.patch('/:contextId/versions/:id/files/:fullpath*',
  function (req, res, next) {
    req.params.fullpath = req.path.replace(
      '/' + req.params.contextId + '/versions/' + req.params.id + '/files/', '');
    next();
 ...
 *  @memberof module:rest/contexts/versions/files */
app.delete('/:contextId/versions/:id/files/:fullpath*',
  function (req, res, next) {
    req.params.fullpath = req.path.replace(
      '/' + req.params.contextId + '/versions/' + req.params.id + '/files/', '');
    next();
