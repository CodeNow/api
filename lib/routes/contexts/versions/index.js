...
/** Get the most recent basic version of a {@link module:models/context Context}
 *  @param {ObjectId} contextId ID of the {@link module:models/context Context}
 *  @param {ObjectId} id ID of the {@link module:models/version Version}
 *  @returns {object} Info on the most recent basic version
 *  @event GET rest/contexts/:contextId/versions/:id/rollback
 *  @memberof module:rest/contexts/versions */
app.get('/contexts/:contextId/versions/:id/rollback',
  findContext,
  contextVersions.findById('params.id'),
  checkFound('contextVersion'),
  contextVersions.model.findLatestBasicVersion(),
  checkFound('contextVersion'),
  mw.res.json('contextVersion'));
