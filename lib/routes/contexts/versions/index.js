...
app.post('/contexts/:contextId/versions/:id/actions/build',
  ...
  mw.req('contextVersion.build.started').require()
    ...
    .else( // no dupe found, build NOT started yet
      ...
      mw.req('contextVersion.build._id').validate(validations.notEqualsKeypath('cachedBuildId'))
        ...
        .else(
          flow.try(
            ...
            docker.model.createImageBuilder('contextVersion', 'dockerTag', 'sauronResult'),
