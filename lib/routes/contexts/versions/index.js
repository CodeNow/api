...
var createFromSource = flow.series(
  ...
  infraCodeVersions.model.copyFilesFrom('query.fromSource'),
  infraCodeVersions.findById('infraCodeVersion._id'),
...
app.get('/:contextId/versions/:id',
  ...
  checkFound('contextVersion'),
  contextVersions.model.getGithubUserInformation('sessionUser.accounts.github.accessToken'),
