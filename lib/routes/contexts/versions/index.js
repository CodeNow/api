...
var dotFlattenObject = transformations.dotFlattenObject;
...
app.get('/:contextId/versions',
  ...
  mw.query('appCodeVersions', 'infraCodeVersion').pick(),
  mw.query('appCodeVersions.repo').require().then(mw.query('appCodeVersions.repo').string()),
  mw.query('appCodeVersions.commit').require().then(mw.query('appCodeVersions.commit').string()),
  mw.query('infraCodeVersion').require().then(mw.query('infraCodeVersion').string()),
  mw.query().set('context', 'params.contextId'),
  mw.query().transform(dotFlattenObject),
  contextVersions.find('query'),
...
app.post('/:contextId/versions/:id/actions/copy',
  ...
  contextVersions.findById('params.id'),
  checkFound('contextVersion'),
  contextVersions.createDeepCopy('sessionUser'),
  mw.res.json('contextVersion'));
