...
app.post('/:contextId/versions',
  ...
  mw.req('context.isSource').validate(validations.equals(true))
    .then(
      mw.body().set('environment', 'context._id'),
      mw.req().set('project', 'context')) // Edge-case!:: sources dont need an env or project
    .else(
...
app.post('/:contextId/versions/:id/actions/discardFileChanges',
  ...
  mw('infraCodeVersion')('parent').require()
    .then(infraCodeVersions.model.copyFilesFrom('infraCodeVersion.parent'))
