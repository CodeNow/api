...
app.post('/contexts/',
  ...
  mw.body('isSource').require()
    .then(
      mw.body('isSource').boolean(),
      me.isModerator) // Only Moderators should be able to create Source Contexts
    .else(flow.or(
      me.isOwnerOf('body'),
      me.isModerator)),
 ...
 *  @memberof module:rest/contexts */
app.put('/contexts/', function(req, res) {
  res.send(405);
});
 ...
 *  @memberof module:rest/contexts */
app.patch('/contexts/', function(req, res) {
  res.send(405);
});
 ...
 *  @memberof module:rest/contexts */
app.delete('/contexts/', function(req, res) {
  res.send(405);
});
 ...
 *  @event PUT rest/contexts
 *  @memberof module:rest/contexts */
app.put('/contexts/:id', function(req, res) {
  res.send(405);
});
