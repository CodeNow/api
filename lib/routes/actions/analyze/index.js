...
var suggestableServicesPHP = require('./data/suggestable-services-php');
...
function extractPHP (req, res, next) {
  ...
  try {
    ...
    debug('invalid composer.json file', req.languageFramework, req.query.repo);
  }
