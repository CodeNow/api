...
/**
j* extract list of modules required by project repository
 *
 ...
 */
function extractProjectDependencyList (req, res, next) {
  ...
  switch (req.languageFramework) {
    case 'javascript_nodejs':
      ...
      // some package.json files may not have dependencies
      dependencies = (!depFile || !depFile.dependencies) ? [] : Object.keys(depFile.dependencies);
      break;
    case 'ruby_ror':
      break;
    case 'python':
