...
var followBranch = flow.series(
  ...
  notifications.create({slack: {webhook: 'https://hooks.slack.com/services/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'},
                        hipchat: {authToken: 'a4bcd2c7007379398f5158d7785fa0', roomId: '1076330'}}),
  notifications.model.notifyOnInstance('commitLog', 'contextVersions'),
