        ...
        failureCb: function (failureKeyPathValue, req, res, next) {
          req.infoObjects.forEach(function (infoObject) {
            ...
            req.pullRequests.forEach(function (pr) {
              ...
              var prData = createPullRequestInfoObject(pr, req.githubPushInfo);
...
function createPullRequestInfoObject (pullRequest, githubPushInfo) {
  return  {
...
function createPullRequestInfo (pullRequest, req, eachReq, res, next) {
  eachReq.githubPullRequest = createPullRequestInfoObject(pullRequest,
    req.githubPushInfo);
  next();
}
