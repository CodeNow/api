...
/** steps
    ...
    2. find all context versions that has this repo and branch as app code
    3. for each context version do
      a. deep copy of context version
      b. update app code version to the new received via github hook
      c. build each context version
      d. send notification after build is ready (and deployed in case when instance was setup for tracking)
 */
