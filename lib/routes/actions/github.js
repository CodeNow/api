...
var newContextVersion = flow.series(
  ...
  mw.log('parent context version id', 'contextVersion._id', 'contextVersion.appCodeVersions'),
  ...
  mw.log('going to update app code', 'contextVersion._id', 'contextVersion.appCodeVersions', 'headCommit.id', 'lowerBranch', 'contextVersion.build'),
  ...
  mw.log('after app code update', 'contextVersion._id', 'contextVersion.appCodeVersions', 'headCommit.id', 'lowerBranch', 'contextVersion.build'),
  contextVersions.findById('contextVersionId'),
  mw.log('after app code update2', 'contextVersion._id', 'contextVersion.appCodeVersions', 'headCommit.id', 'lowerBranch', 'contextVersion.build')
);
