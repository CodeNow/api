...
function autoFork () {
  return flow.series(
    checkEnvOn('ENABLE_AUTOFORK_ON_GITHUB_HOOK',
      202, 'Auto-forking on github hooks is disabled for now'),
    timers.create(),
...
function createAndBuildBuild (githubInfo) {
  return flow.series(
    ...
    mw.log('createAndBuildBuild2', 'runnableResult'),
