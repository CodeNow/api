        ...
        function (req, res, next) {
          if (req.jsonNewBuild) {
            ...
            req.socketClient.addHandler(buildStartedEvent, function (contextVersion) {
              // remove event handler. we don't need it anymore
              req.socketClient.removeHandler(buildStartedEvent);
            ...
            req.socketClient.addHandler(buildCompletedEvent, function (contextVersion) {
              // remove event handler. we don't need it anymore
              req.socketClient.removeHandler(buildCompletedEvent);
              if (contextVersion.build.error) {
                ...
                req.socketClient.addHandler(instanceDeployedEvent, function (instance) {
                  // remove event handler. we don't need it anymore
                  req.socketClient.removeHandler(instanceDeployedEvent);
