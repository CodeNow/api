...
function followBranch (instancesKey) {
  return flow.series(
    ...
    function (req, res, next) {
      ...
      // join org room
      var contextOwnerGithub = req.instances[0].owner.github;
      console.log('data', contextOwnerGithub);
      socketClient.joinOrgRoom(contextOwnerGithub);
          ...
          if (req.jsonNewBuild) {
            ...
            req.socketClient.addHandler(buildCompletedEvent, function (contextVersion) {
              ...
              if (contextVersion.build.error) {
                ...
                // build was successful - deploy it to the instance
