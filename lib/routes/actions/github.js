                    ...
                    .then(function (newInstances) {
                      return Promise.each(
                        ...
                        function isolateEachNewInstance (i) {
                          log.debug({ instanceId: i._id, parent: i.parent }, 'looking for aics')
                          return Instance.findOne({ shortHash: i.parent })
                            .then(function (fullParentInstance) {
                              ...
                              return AutoIsolationConfig.findOne({
                            ...
                            .then(function (aic) {
                              ...
                              .then(function (result) {
                                var isolationConfig = {
                                  master: newInstances[0].id.toString(),
                                  children: []
                                }
