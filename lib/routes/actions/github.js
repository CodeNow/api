...
var newContextVersion = flow.series(
  ...
  mw.log('going to update app code', 'contextVersion.appCodeVersions', 'headCommit.id', 'lowerRepo'),
  ...
  mw.log('after app code update', 'contextVersion.appCodeVersions', 'headCommit.id', 'lowerRepo', 'contextVersion.build'),
  contextVersions.model.findBydId('contextVersions._id'),
  mw.log('after app code update2', 'contextVersion.appCodeVersions', 'headCommit.id', 'lowerRepo', 'contextVersion.build')
);
