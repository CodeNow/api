...
var newContextVersion = flow.series(
  ...
  mw.log('going to update app code', 'contextVersion.appCodeVersions', 'headCommit.id', 'lowerBranch', 'contextVersion.build'),
  ...
  mw.log('after app code update', 'contextVersion.appCodeVersions', 'headCommit.id', 'lowerBranch', 'contextVersion.build'),
  contextVersions.findById('contextVersionId'),
  mw.log('after app code update2', 'contextVersion.appCodeVersions', 'headCommit.id', 'lowerBranch', 'contextVersion.build')
);
