...
var updateUser = series(
  ...
  mw.body('accounts.slack.orgs[0]').require()
    .then(
      req.set('slackAccount', 'accounts.slack.orgs[0]'),
      settings.findById('slackAccount.githubId'),
      mw.log('settings for the user', 'setting'),
      // find slackApiToken
      req.set('slackApiToken', 'setting.notifications.slack.apiToken'),
      slack.create('slackApiToken'),
      slack.models.findSlackUserByUsername('slackAccount.name'),
