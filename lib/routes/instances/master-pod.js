...
app.put('/instances/:index/masterPod',
  ...
  hosts.new(),
  hosts.model.upsertHostsForInstance('sessionUser.accounts.github.username', 'instance', 'cb'),
  mw.res.send(204));
...
app.delete('/instances/:id/masterPod',
  ...
  mw.req('instance.container.dockerContainer').require()
    .then(
      ...
      hosts.model.removeHostsForInstance('sessionUser.accounts.github.username', 'instance', 'cb')
    ),
  mw.res.send(204));
