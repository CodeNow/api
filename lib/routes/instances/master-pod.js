    ...
    .then(
      ...
      function (req, res, next) {
        ...
        var branch = keypather.get(ContextVersion.getMainAppCodeVersion(appCodeVersions),
          'lowerBranch');
        req.mainBranch = branch;
        next();
      },
      hosts.model.removeHostsForInstance('instance.owner.username', 'mainBranch',
        'instance.shortHash','instance.owner.github', 'instance.masterPod',
        'instance.name', 'instance.container', 'cb')
    ),
  mw.res.send(204));
