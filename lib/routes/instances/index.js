...
var t = require('middlewares/timers');
...
app.get('/instances/',
  ...
  t.startTimer('githubUsername_check'),
  ...
  t.stopTimer('githubUsername_check'),
  mw.query({or: [
  ...
  t.startTimer('getGithubUsername'),
  instances.models.getGithubUsername('sessionUser'),
  t.stopTimer('getGithubUsername'),
  t.startTimer('instance-route:populateModels'),
  instances.models.populateModels(),
  t.stopTimer('instance-route:populateModels'),
