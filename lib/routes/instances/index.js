  ...
  flow.background( // background container create task
    flow.try(
      ...
      function (req, res, next) {
        ...
        var cvId = req.contextVersion.id().toString();
        var labels = {
          contextVersionId : cvId,
          instanceId       : req.instance._id.toString(),
          instanceName     : req.instance.name.toString(),
          instanceShortHash: req.instance.shortHash.toString(),
          ownerUsername    : req.ownerUsername,
          creatorGithubId  : req.instance.createdBy.github.toString(),
          ownerGithubId    : req.instance.owner.github.toString()
        };
