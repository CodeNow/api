...
var saveInstanceContainer = flow.series(
  ...
  instances.model.setContainer('sessionUser', 'dockerResult'),
...
app.post('/instances/',
  ...
  flow.try(
    ...
    sauron.model.deleteHost(
      'sauronResult.networkIp', 'sauronResult.hostIp'),
    mw.next('err')
  ),
...
app.patch('/instances/:id',
  ...
  mw.body('env').require()
    .then(
      mw.body('env').array().validate(validations.isArrayOf('string'))),
...
app.delete('/instances/:id',
  ...
  mw.req('instance.network').require()
    .then(
      ...
      sauron.create(),
      sauron.model.deleteNetwork('instance.network'),
      sauron.model.deleteHost('instance.host')),
  // remove instance
