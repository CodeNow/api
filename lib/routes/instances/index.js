  ...
  mw.req('containerInfo').require()
    .then( // container create was successful
      ...
      flow.try(
        ...
        instances.model.modifySetContainer(
          'contextVersion._id', 'containerInspect', 'dockerHost')
      ).catch(
        // this logic is to ensure something is set for container inspect
        mw.req().setToErr('containerInspectErr'),
        instances.model.modifySetContainerInspectErr(
          'contextVersion._id', 'containerInspectErr')
      ),
