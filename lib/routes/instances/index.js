...
app.get('/instances/',
  ...
  flow.or(
    ...
    me.isModerator.require()
  ),
  // Only use 'container.dockerContainer' in query if owner is a moderator
  mw.query('container.dockerContainer').require()
    .then(
      me.isModerator.require(),
      mw.query('container.dockerContainer').pick()),
  mw.log('x-ryan', 'query'),
  instances.find('query'),
  mw.log('x-ryan', 'instances'),
