...
var createSaveAndNetworkContainer = flow.series(
  ...
  mw.log('createSaveAndNetworkContainer 1'),
  ...
  flow.try(
    mw.log('createSaveAndNetworkContainer 2'),
    docker.create('dockerHost'),
    mw.log('createSaveAndNetworkContainer 3'),
    docker.model.createUserContainer('contextVersion', { Env: 'instance.env' }),
    mw.log('createSaveAndNetworkContainer 4'),
  ...
  mw.req('containerInfo').require()
    .then( // container create was successful
      mw.log('createSaveAndNetworkContainer 5. starting container', 'containerInfo'),
      docker.model.startUserContainer('containerInfo'),
      mw.log('createSaveAndNetworkContainer 6'),
