...
var logInfoMiddleware = require('middlewares/log-info-middleware')('routes:instances:index');
...
app.post('/instances/:id/actions/deploy',
  ...
  flow.try(
    ...
    instances.findById('instanceId'),
    logInfoMiddleware(['instance', 'user', 'build'], 'instance deploy'),
    // create container
    createContainer,
    instances.model.populateOwnerAndCreatedBy('sessionUser'))
  .catch(
