...
var createAllContainers = flow.series(
  ...
  docklet.create(),
  docklet.model.findDock('container_build', 'contextVersion.dockerHost'),
...
var removeAllContainers = flow.series(
  ...
  hipacheHosts.model.removeRoutesForInstance('instance'),
  // delete containers
  // XXX FIXME: BROKEN: we are supposed to use dock which the container is on
  docklet.create(),
  docklet.model.findDock('container_delete', 'contextVersion.dockerHost'),
  docker.create('dockletResult'),
