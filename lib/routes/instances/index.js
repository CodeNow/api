...
app.get('/instances/',
  // If the requesting user is a moderator we don't require that they provide a github
  // user id to the query (since they should be able to query for basically anything).
