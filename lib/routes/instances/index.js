...
app.delete('/instances/:id',
  ...
  // delete all instances that were forked from master instace
  mw.req('instance.masterPod').validate(validations.equals(true))
    .then(
      runnable.create({}, helloRunnableUser),
      runnable.model.destroyForkedIstances('instance')),
