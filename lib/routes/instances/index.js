...
function fIXME_MessengerEmitInstanceUpdate (action) {
  return function (req, res, next) {
    // FIXME: remove when we have singleton middleware
    messenger.emitInstanceUpdate(req.instance, action, next);
  };
}
function fIXME_MessengerEmitImagePulling () {
  return function (req, res, next) {
    // FIXME: remove when we have singleton middleware
    messenger.emitImagePulling(req.instance, req.dockerResult, next);
  };
}
  ...
  .catch(
    ...
    mw.req('containerCreateErr.imageIsPulling').validate(validations.equals(true))
      .then(
        ...
        fIXME_MessengerEmitImagePulling(),
...
app.post('/instances/',
  ...
  fIXME_MessengerEmitInstanceUpdate('post'),
...
app.patch('/instances/:id',
  ...
  instances.model.populateModels(),
  fIXME_MessengerEmitInstanceUpdate('patch'),
  mw.res.json('instance'));
...
app.delete('/instances/:id',
  ...
  // release lock
  hosts.model.releaseHostLock('ownerUsername', 'deletedInstance.name'),
  fIXME_MessengerEmitInstanceUpdate('delete'),
...
app.post('/instances/:id/actions/deploy',
  ...
  fIXME_MessengerEmitInstanceUpdate('deploy'),
  mw.res.json('instance'));
...
app.post('/instances/:id/actions/redeploy',
  ...
  instances.model.populateModels(),
  mw.req().set('instance.owner.username', 'ownerUsername'),
  fIXME_MessengerEmitInstanceUpdate('redeploy'),
  mw.res.json('instance'));
...
app.put('/instances/:id/actions/start',
  ...
  instances.model.populateModels(),
  mw.req().set('instance.owner.username', 'ownerUsername'),
  fIXME_MessengerEmitInstanceUpdate('start'),
  mw.res.json('instance'));
...
app.put('/instances/:id/actions/restart',
  ...
  instances.model.populateModels(),
  mw.req().set('instance.owner.username', 'ownerUsername'),
  fIXME_MessengerEmitInstanceUpdate('restart'),
  mw.res.json('instance'));
...
app.put('/instances/:id/actions/stop',
  ...
  instances.model.populateModels(),
  mw.req().set('instance.owner.username', 'ownerUsername'),
  fIXME_MessengerEmitInstanceUpdate('stop'),
  mw.res.json('instance'));
