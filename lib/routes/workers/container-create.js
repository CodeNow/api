...
var logInfoMiddleware = require('log-info-middleware')('routes:workers:container-create');
...
app.post('/workers/container-create',
  ...
  logInfoMiddleware(['instanceShortHash', 'instance.toJSON()'], 'worker update instance finish'),
