...
var logger = require('middlewares/logger')('routes:workers:container-create');
...
app.post('/workers/container-create',
  ...
  logger(['instanceShortHash', 'updateOpts'], 'worker update instance start'),
  runnable.model.updateInstance('instanceShortHash', 'updateOpts', 'cb').async('instance'),
  logger(['instanceShortHash', 'instance'], 'worker update instance finish'),

  logger(['instanceShortHash'], 'worker start instance start'),
  runnable.model.startInstance('instanceShortHash', 'cb').async(),
  logger(['instanceShortHash'], 'worker start instance finish'),
