...
app.get('/',
  ...
  mw.query('owner').require()
    .then(mw.query('owner').validate(validations.isObjectId)),
...
app.post('/',
  ...
  mw.body('owner.github').require()
    ...
    .else(function (req, res, next) { req.body.owner = { github: req.sessionUser.accounts.github.id }; next(); }),
  mw.log('sessionUser'),
  mw.log('sessionUser.accounts.github.id'),
  mw.log('body'),
