...
var utils = module.exports = {
  ...
  log: function (/*message, keys...*/) {
    ...
    return function (req, res, next) {
      ...
      console.log.apply(console, localKeys);
      next();
    };
  },
  ...
  series: function (/*middlewares*/) {
    ...
    return function (req, res, next) {
      ...
      async.series(tasks, req.domain.intercept(function (err) {
        next();
      }));
    };
  },
  ...
  if: function (key /*, middlewares*/) {
    var middlewares = Array.prototype.slice.call(arguments, 1);
    return utils.ternary(utils.require(key),
