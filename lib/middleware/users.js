...
var users = module.exports = {
  fetchSelf: function (req, res, next) {
    async.waterfall([
      replaceMeWithUserId.bind(null, req, res),
  ...
  fetchUser: function (req, res, next) {
    if (req.user) { //fetched with self
      return next();
    }
    async.waterfall([
      replaceMeWithUserId.bind(null, req, res),
      User.findById.bind(User, req.params.userId)
    ],
    req.domain.intercept(function (user) {
      if (!user) {
  ...
  isUser: function (req, res, next) {
    replaceMeWithUserId(req, res, req.domain.intercept(function () {
...
function replaceMeWithUserId (req, res, next) {
