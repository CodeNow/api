...
// var files = module.exports = createMongooseMiddleware('file', {
//   findByFilepaths: function (filepathsKey) {
//     return function (req, res, next) {
//       var filepaths = keypather.get(req, filepathsKey) || [];
//       if (!Array.isArray(filepaths)) {
//         filepaths = [filepaths];
//       }
//       req.files = req.container.findFilesByFilepaths(filepaths);
//       next();
//     };
//   },
//   findContainerFileFields: function (req, res, next) {
//     var returnFileContents = req.query.content || req.query.default;

//     var fields = (returnFileContents) ?
//       null : { 'files.content': 0 };

//     // Filtering problems, removed 2nd arg to findById
...
//         container: Container.findById.bind(Container, container._id)
//       }),
//       function (results, cb) {
