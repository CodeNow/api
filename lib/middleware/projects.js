...
module.exports = createMongooseMiddleware(Project, {
  ...
  findPage: function (queryKey, fieldsKey) {
    return function (req, res, next) {
      var query = keypather.get(req, queryKey);
      var fields = fieldsKey ? keypather.get(req, fieldsKey) : null;
      var paging = {
        limit: query.limit,
      ...
      delete query.page;
      delete query.limit;
      Project.find(query, fields, paging, function (err, data) {
        req.projects = data;
        next(err);
      });
    };
