...
app.use(require('cls-middleware')(require('models/cls-namespace')));
app.use(require('middlewares/set-req-in-namespace'));
if (envIs('production')) {
...
app.get('/', function (req, res) {
  require('error').log(new Error('TEST ERROR LOGGING'));
  res.json({
