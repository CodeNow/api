...
var createWorker = require('process/create-worker');
...
Master.prototype.cycleWorkers = function () {
  if (!WORKER_LIFE_INTERVAL) { return; }
  var worker = keypather.get(this, 'workers[0].worker'); // kill worker in first position
