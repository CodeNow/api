...
Messenger.prototype._emitInstanceUpdateAction = function (instance, action) {
  ...
  dogstatsd.gauge('instance.container.status', statusToGuageMap[status], tags)
  dogstatsd.gauge('instance.container.migrating', runnableInstance.isMigrating() ? 1 : 0, tags)
}
