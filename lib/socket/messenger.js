...
Messenger.prototype.emitInstanceUpdate = function (instance, action) {
  ...
  if (!instance || !action) {
    log.fatal('Messenger.prototype.emitInstanceUpdate died')
  ...
  if (!requiredKeypaths.every(keypather.in.bind(keypather, instance))) {
    ...
    log.fatal('Messenger.prototype.emitInstanceUpdate failed validation')
...
Messenger.prototype._emitInstanceUpdateAction = function (instance, action) {
  ...
  if (!instance) {
    log.fatal('Messenger.prototype._emitInstanceUpdateAction invalid')
