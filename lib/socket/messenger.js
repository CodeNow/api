...
Messenger.prototype._emitInstanceUpdateAction = function (instance, action) {
  ...
  dogstatsd.gauge('instance.container.status', statusToGuageMap[status], .5, tags)
  dogstatsd.gauge('instance.container.migrating', runnableInstance.isMigrating() ? 1 : 0, .5, tags)
}
