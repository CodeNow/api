...
Messenger.prototype._emitInstanceUpdateAction = function (instance, action) {
  ...
  var runnableInstance = runnable.newInstance(instance)
  ...
  }, '_emitInstanceUpdateAction setting instance container status gauge')
  dogstatsd.gauge('instance.container.status', statusToGuageMap[status], 1, tags)
  dogstatsd.gauge('instance.container.migrating', runnableInstance.isMigrating() ? 1 : 0, 1, tags)
}
