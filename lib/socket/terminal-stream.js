...
function setupStream (socket, data) {
  ...
  if (terminalConnections[terminalId]) {
    if (terminalConnections[terminalId].containerId !== data.containerId) {
  ...
  function connectStream () {
    ...
    if (terminalConnections[terminalId].lastMessage) {
      clientTermStream.write(terminalConnections[terminalId].lastMessage)
    }
    cleanStream.pipe(clientTermStream)
    cleanStream.on('data', function (lastMessage) {
      terminalConnections[terminalId].lastMessage = lastMessage
    })
