...
BuildStream.prototype.handleStream = function () {
  ...
  return commonStream.validateDataArgs(this.data, reqArgs)
    ...
    .tap(version => {
      ...
      tags.containerId = keypather.get(version, 'build.dockerContainer')
      tags.dockHost = keypather.get(version, 'dockerHost')
    ...
    .then(version => {
      ...
      return commonStream.pipeLogsToClient(clientStream, containerId, {
        parseJSON,
        baseDataName,
        tags
      })
