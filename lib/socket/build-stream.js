...
BuildStream.prototype.handleStream = function () {
  ...
  return commonStream.validateDataArgs(this.data, reqArgs)
    ...
    .then(function (version) {
      return commonStream.checkOwnership(this.sessionUser, version).returns(version)
    })
    .then(function (version) {
    ...
    .catch(commonStream.onValidateFailure('handleStream', this.socket, this.id, logData))
}
