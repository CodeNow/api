...
BuildStream.prototype.handleStream = function () {
  ...
  return commonStream.validateDataArgs(this.data, reqArgs)
    .bind(this)
    .then(() => {
      return commonStream.ensureModelAccessByContainerId(this.data.containerId, this.sessionUser)
    })
    .tap(res => {
      const instance = res.instance
      tags.container_id = this.data.containerId
      tags.container_id = res.isCurrentContainer
      tags.result = 'success'
