...
function Server() {
  ...
  this.primus = this.socketServer.primus;
  this.socketServer.addHandler('build-stream', buildStream.buildStreamHandler);
  this.socketServer.addHandler('log-stream', logStream.logStreamHandler);
  this.socketServer.addHandler('terminal-stream', primusProxy.proxyStreamHandler);
  return this;
}
