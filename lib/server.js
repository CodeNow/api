 ...
 */
Server.prototype.listenToSIGINT = function () {
 ...
 */
Server.prototype.removeListenerSIGINT = function () {
 ...
 */
Server.prototype._handleSIGINT = function () {
  console.log('SIGINT: recieved');
  this.stop(function (err) {
    if (err) {
      return console.error('SIGINT: stop failed', err.stack);
    }
    console.log('SIGINT: stop succeeded, wait some time to ensure the process has drained');
  });
};
