...
module.exports.task = (job) => {
  ...
  .spread(function initiateBuild (user, contextVersion) {
    ...
    return contextVersion.populateAsync('infraCodeVersion')
      .then(function fetchOrg () {
        return OrganizationService.getByGithubUsername(job.ownerUsername)
      })
      .then(function createImageBuilderContainer (organization) {
        ...
        return dockerClient.createImageBuilderAsync({
          ...
          organization: {
            ...
            private_registry_url: organization.private_registry_url,
            private_registry_username: organization.private_registry_username
          },
