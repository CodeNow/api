    ...
    .then(function fetchRequiredModels () {
      ...
      return Promise
        ...
        .spread(function validateModels (user, context, contextVersion) {
          workerUtils.assertFound(queueName, job, 'User', { githubId: job.sessionUserId })(user)
          workerUtils.assertFound(queueName, job, 'Context', { contextId: job.contextId })(context)
          workerUtils.assertFound(queueName, job, 'ContextVersion', { query: contextVersionQuery })(contextVersion)
