 ...
 * Right now we just send notifications.
...
module.exports = InstanceDeployedNotify
 ...
 * @resolve {undefined}
 */
function InstanceDeployedNotify (job) {
  var log = logger.child({
    module: 'InstanceDeployedNotify',
    tx: true,
    data: job
  })
    ...
    .then(function () {
      ...
      .spread(function validateModels (instance, cv) {
        ...
        return Promise.props({
          ...
          pushUser: User.findByGithubIdAsync(cv.createdBy.github)
