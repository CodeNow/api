...
module.exports.jobSchema = joi.object({
  ...
  tid: joi.string()
}).unknown().required().label('instance.container.create job')

/** @type {Number} max retry delay for the job. 15 minutes for now to include new dock creation */
module.exports.maxRetryDelay = 90000
...
module.exports.maxNumRetries = 10
 ...
 */
module.exports.task = function InstanceContainerCreate (job) {
  const log = logger.child({ method: 'InstanceContainerCreate' })
  log.info('InstanceContainerCreate called')
