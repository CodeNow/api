 ...
 * @returns {Promise}
 */
ContainerImageBuilderDied.task = (job) => {
  ...
  return ContainerImageBuilderDied._publishParallelTasks(job)
    .then(() => {
 ...
 * @return {Promise}
 */
ContainerImageBuilderDied._publishParallelTasks = (job) => {
  return Promise.try(() => {
 ...
 */
ContainerImageBuilderDied._handleAutoDeploy = (versions) => {
 ...
 */
ContainerImageBuilderDied._getBuildInfo = (job) => {
  var log = logger.child({
 ...
 */
ContainerImageBuilderDied._createContainersIfSuccessful = (job, instances, buildInfo) => {
 ...
 * @private
 */
ContainerImageBuilderDied._killIsolationIfNeeded = (job, instances) => {
  var log = logger.child({
    job: job,
