 ...
 */
BaseWorker.prototype._pBaseWorkerFindContextVersion = Promise.promisify(BaseWorker.prototype._baseWorkerFindContextVersion);
 ...
 */
BaseWorker.prototype._pBaseWorkerUpdateInstanceFrontend = Promise.promisify(BaseWorker.prototype._baseWorkerUpdateInstanceFrontend);
...
BaseWorker.prototype.pFindInstance = Promise.promisify(BaseWorker.prototype._baseWorkerFindInstance);
  ...
  async.retry({
    ...
    if (err) {
      ...
      self.instance.modifyContainerInspect(self.data.dockerContainer,
        result, function(err2, _instance) {
          if (err2) {
            log.warn(put({
              err: err2
