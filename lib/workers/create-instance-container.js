  ...
  async.series([
    ...
    function (cb) {
      log.info(put({
        ...
        contextVersion: contextVersion,
        data: data
      }, self.logData), 'CreateInstanceContainerWorker.prototype._handle404 step1');
      cb();
    },
    ...
    function (cb) {
      log.info(put({
        ...
        contextVersion: contextVersion,
        data: data
      }, self.logData), 'CreateInstanceContainerWorker.prototype._handle404 step2');
      cb();
    },
...
CreateInstanceContainerWorker.prototype._handleAppError = function (instanceId, cvId, err, cb) {
  log.info(put({
    instanceId: instanceId,
    cvId: cvId,
    err: err
  }, this.logData), 'CreateInstanceContainerWorker.prototype._handleAppError');
