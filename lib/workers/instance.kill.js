...
function KillInstanceWorker () {}

module.exports = KillInstanceWorker

KillInstanceWorker.jobSchema = joi.object({
  instanceId: joi.string().required(),
  containerId: joi.string().required(),
  tid: joi.string()
}).required().label('instance.kill job')

KillInstanceWorker.msTimeout = 10000

KillInstanceWorker.maxNumRetries = 5
 ...
 * @return {Promise}
 */
KillInstanceWorker.finalRetryFn = function (job) {
 ...
 */
KillInstanceWorker.task = function (job) {
