...
._setInstanceStateStarting = function (setInstanceStateStartingCb) {
  log.info(this.logData, 'StopInstanceContainerWorker.prototype._setInstanceStateStarting');
  var self = this;
 ...
 */
StopInstanceContainerWorker.prototype._startContainer = function (startContainerCb) {
  log.info(this.logData, 'StopInstanceContainerWorker.prototype._startContainer');
  var self = this;
  var attemptCount = 0;
  async.retry({
...
._attachContainerToNetwork = function (attachContainerToNetworkCb) {
    log.info(this.logData, 'StopInstanceContainerWorker.prototype._attachContainerToNetwork');
