  ...
  return joi.validateOrBoomAsync(job, schema)
    ...
    .then(function () {
      return Promise.fromCallback(function (cb) {
        ContextVersion.markDockRemovedByDockerHost(job.host, function (err) {
          log.trace(logData, 'OnDockRemovedWorker - ContextVersion.markDockRemovedByDockerHost FINISHED!!! OMG')
          cb(err)
        })
      })
    })
