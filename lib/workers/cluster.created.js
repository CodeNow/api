  ...
  .then(() => {
    ...
    return UserService.getCompleteUserByBigPoppaId(job.sessionUserBigPoppaId)
      .then(function (sessionUser) {
        ...
        return DockerComposeClusterService.createClusterParent(sessionUser, mainInstanceDef, job.repoFullName, job.triggeredAction)
      })
      .then(function (parentInstance) {
        ...
        log.info({ newJob }, 'publish new event that parent instance was created')
