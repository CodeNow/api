    ...
    docker.createImageBuilder(
      ...
      function (err, container) {
        if (err) {
          ...
          console.log('CONFTAINERR', container);
          self.container = container.dockerContainer;
          self.dockerContainerId = container.dockerContainer.Id;
          log.trace(put({
            attemptCount: attemptCount,
            container: pick(container, ['dockerContainer', 'dockerHost']),
