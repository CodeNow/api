  ...
  return joi.validateOrBoomAsync(job, schema)
    ...
    .then(function () {
      ...
      return Promise.fromCallback(function (cb) {
        Instance.findIsolationMaster(job.isolationId, cb)
      })
    })
    .then(function (masterInstance) {
      log.trace('Master instance for isolation found')
      var fullRepoName = masterInstance.contextVersion.appCodeVersions[0].repo
      var commitHash = masterInstance.contextVersion.appCodeVersions[0].commit
      log.trace({
