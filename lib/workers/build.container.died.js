...
class Worker {
  constructor (job) {
    ...
    const log = this.log.child({ method: 'constructor' })
    log.info('called')
    log.info('my magic string to find this invocation')
    ...
    log.info('my magic string to end this invocation')
  }
   ...
   */
  task () {
    const log = this.log.child({ method: 'taskConstructor' })
