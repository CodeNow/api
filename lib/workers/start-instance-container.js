...
StartInstanceContainerWorker.prototype.handle = function (data, done) {
  ...
  async.series([
    ...
    this._setInstanceStateStarting(this),
    ...
    if (err) {
      log.warn(put({err: err}, self.logData),
        'StartInstanceContainerWorker.prototype.handle final error');
      if (self.instance) {
        log.trace(put({err: err}, self.logData),
          'StartInstanceContainerWorker.prototype.handle final error - instance');
        /**
 ...
 */
StartInstanceContainerWorker.prototype._setInstanceStateStarting =
function (setInstanceStateStartingCb) {
