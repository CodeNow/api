...
function (buildInfo, handleBuildErrorCb) {
  ...
  ContextVersion.updateBuildErrorByContainer(this.data.id, err, handleBuildErrorCb);
};
...
function (buildInfo, handleBuildSuccessCb) {
  ...
  ContextVersion.updateBuildCompletedByContainer(this.data.id, buildInfo, handleBuildSuccessCb);
};
