...
var rabbitMQ = require('models/apis/rabbitmq');
...
OnInstanceContainerCreateWorker.prototype._updateInstance = function (updateInstanceCb) {
  ...
  Instance.findOneAndUpdate({
    ...
    if (err) {
      ...
      log.info(self.logData, '_updateInstance findOneAndUpdate success');
    }
...
OnInstanceContainerCreateWorker.prototype._startContainer = function (cb) {
  ...
  rabbitMQ.hermesClient.publish('start-instance-container', {
    ...
    networkIp: this.intance.network.networkIp,
    ownerUsername: this.instance.instance.owner.username,
    sessionUserGithubId: this.data.sessionUserGithubId,
