...
function ContainerImageBuilderStarted (job) {
  ...
  return joi
    ...
    .then(function updateContextVersion () {
      ...
      log.info(put({ contextVersionBuildId: contextVersionBuildId }, logData), 'ContainerImageBuilderStarted: updateContextVersion')
    ...
    .then(function emitContextVersionUpdate (contextVersions) {
      log.info(put({ numContextVersions: contextVersions.length }, logData), 'ContainerImageBuilderStarted: emitContextVersionUpdate')
