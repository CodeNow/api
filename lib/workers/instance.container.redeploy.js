...
}).unknow().required().label('instance.container.redeploy job')

module.exports.task = InstanceContainerRedeployWorker
/**
...
function InstanceContainerRedeployWorker (job) {
  const log = logger.child({ method: 'InstanceContainerRedeployWorker' })
