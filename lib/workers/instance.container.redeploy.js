  ...
  return joi.validateOrBoomAsync(job, schema)
    ...
    .then(function (instance) {
      ...
      if (!instance.container) {
        throw new TaskFatalError(
          'instance.container.redeploy',
          'Cannot redeploy an instance without a container',
          { job: job }
        )
      }
      return instance
    ...
    .then(function (data) {
      ...
      return Promise.fromCallback(function (cb) {
        data.instance.update({
          $unset: { container: 1 },
          $set: { 'contextVersion._id': objectId(cvId) }
        }, cb)
      })
      .then(function (instance) {
    ...
    .then(function (data) {
      ...
      InstanceContainerRedeployWorker._deleteOldContainer(job, data)
 ...
 */
InstanceContainerRedeployWorker._deleteOldContainer = function (job, data) {
  ...
  rabbitMQ.deleteInstanceContainer({
    ...
    ownerGithubUsername: keypather.get(data, 'instance.owner.username'),
    deploymentUuid: job.deploymentUuid,
    isolated: data.instance.isolated,
    isIsolationGroupMaster: data.instance.isIsolationGroupMaster
  })
}
