...
module.exports.jobSchema = joi.object({
  ...
  clusterCreateJobUuid: joi.string(),
...
module.exports.task = (job) => {
  ...
  return UserService.getCompleteUserByBigPoppaId(job.sessionUserBigPoppaId)
    .then(sessionUser => {
      const props = [ 'triggeredAction', 'repoFullName', 'branchName', 'filePath', 'isTesting', 'clusterName', 'clusterCreateJobUuid', 'testReporters', 'parentInputClusterConfigId' ]
      ...
      return ClusterConfigService.create(sessionUser, opts)
        ...
        .catch(err => {
          ...
          rabbitMQ.cleanupCluster({
            ...
            clusterName: job.clusterName,
            clusterCreateJobUuid: err.clusterCreateJobUuid
          })
