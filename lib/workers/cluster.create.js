...
module.exports.jobSchema = joi.object({
  ...
  clusterCreateJobHash: joi.string(),
...
module.exports.task = (job) => {
  ...
  return UserService.getCompleteUserByBigPoppaId(job.sessionUserBigPoppaId)
    .then(sessionUser => {
      const props = [ 'triggeredAction', 'repoFullName', 'branchName', 'filePath', 'isTesting', 'clusterName', 'clusterCreateJobHash', 'testReporters', 'parentInputClusterConfigId' ]
      ...
      return ClusterConfigService.create(sessionUser, opts)
        ...
        .catch(err => {
          ...
          rabbitMQ.cleanupCluster({
            bigPoppaId: job.sessionUserBigPoppaId,
            clusterName: job.clusterName,
            clusterCreateJobHash: err.clusterCreateJobHash
          })
