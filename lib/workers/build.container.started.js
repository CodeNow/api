 ...
 *
 * @module lib/workers/build.container.started
 */
'use strict'
require('loadenv')()
...
module.exports.task = (job) => {
  const log = logger.child({ method: 'BuildContainerStarted' })
  return Promise
    ...
    .then(function validateUpdate (updatedCount) {
      ...
      if (updatedCount === 0) {
        throw new WorkerStopError('ContextVersion was not updated', {}, { level: 'info' })
      }
    })
