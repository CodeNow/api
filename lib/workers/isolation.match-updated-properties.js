...
module.exports = MatchUpdatedPropertiesForIsolation
var queueName = 'isolation.match-updated-properties'
 ...
 * @returns {Promise}
 */
function MatchUpdatedPropertiesForIsolation (job) {
  ...
  return joi.validateOrBoomAsync(job, schema)
    ...
    .then(function (res) {
      return Promise.map(res.instances, function (isolationInstance) {
        log.trace({
        ...
        return isolationInstance.updateAsync(job.updates)
          .then(function () {
            ...
            return isolationInstance.emitInstanceUpdateAsync(res.sessionUser, 'update')
          })
      })
    })
}
