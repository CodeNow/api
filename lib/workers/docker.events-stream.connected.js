...
module.exports = function DockerEventsStreamConnected (job) {
  ...
  return joi.validateOrBoomAsync(job, schema)
    ...
    .then(function () {
      ...
      // if error happens on those last two calls we don't want to retry
      // just send a rollbar error for now
      // we can't retry because in this case we need to revert mongo update
      // we can improve this code when we have better transactional support
