...
/**
 * Handle instance.container.created command
 * Flow is following:
 * 1. update instance with inspect data
 * 2. publish startInstance container job
  ...
  return joi.validateOrBoomAsync(job, schema)
    ...
    .then(function () {
      ...
      return Promise.fromCallback(function (cb) {
        ...
        if (statusCode === 409) {
          var fatalError = new TaskFatalError('instance.container.created', 'Instance not found', { job: job })
