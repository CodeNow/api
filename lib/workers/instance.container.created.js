 ...
 * 2. call handleRecovery on contextVersion
...
function InstanceContainerCreatedWorker (job) {
  ...
  return joi.validateOrBoomAsync(job, schema)
    ...
    .then(function (contextVersion) {
      if (!contextVersion) {
        throw new TaskFatalError('instance.container.created', 'ContextVersion not found', { job: job })
      }
      return contextVersion.handleRecoveryAsync()
    })
    .then(function () {
