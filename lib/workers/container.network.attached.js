...
function ContainerNetworkAttachedWorker (job) {
  ...
  return joi.validateOrBoomAsync(job, schema)
    ...
    .then(function (instance) {
      ...
      var hosts = new Hosts()
      log.trace('Begin hosts.upsertHostsForInstanceAsync')
      return hosts.upsertHostsForInstanceAsync(
        ...
        .then(function () {
          log.trace('Finished upsertHostsForInstanceAsync')
        })
        .return(instance)
    })
    .then(function (instance) {
      log.trace({instance: instance}, 'Begin modifyExistingContainerInspectAsync')
      return InstanceService.modifyExistingContainerInspectAsync(
        ...
        .then(function () {
          log.trace('Finished modifyExistingContainerInspectAsync')
        })
        .return(instance)
        .catch(function (err) {
          log.error(err)
