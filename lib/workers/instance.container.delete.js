...
module.exports = InstanceContainerDeleteWorker
 ...
 * @returns {Promise}
 */
function InstanceContainerDeleteWorker (job) {
  var logData = {
    tx: true,
    data: job
  }
  var schema = joi.object({
    ...
    containerPorts: joi.object().required()
  })
  return joi.validateOrBoomAsync(job, schema)
    ...
    .then(function (instance) {
      ...
      var hosts = new Hosts()
      return Promise.fromCallback(function (cb) {
        hosts.removeHostsForInstance(naviEntry, job.containerPorts, cb)
      })
    })
    .then(function (data) {
