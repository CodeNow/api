      ...
      return self.pFindBuild({
        ...
        .then(function (cv) {
          return Promise.props({
            filteredInstances: self._filterAndSaveCvToInstances(instances, cv),
            dockHost: self._getDockHost(cv).bind(self)
          })
            .then(function (data) {
...
/**
 * Wraps the BaseWorker.pFindInstances, this checks to makes sure the instances list isn't empty.
...
DeployInstanceWorker.prototype._emitEvents = function (instances) {
  ...
  var self = this;
  return this.pFindUser(this.sessionUserGithubId).bind(this)
    .then(function () {
      return Promise.all(instances.map(function (instance) {
