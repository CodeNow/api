...
module.exports.task = (job) => {
  ...
  return Promise.props({
    ...
    .then(result => {
      ...
      return ClusterConfigService.fetchFilesFromGithub(bigPoppaUser, fullRepo, filePaths, commit)
        ...
        .then(composeFilesData => {
          ...
          return ClusterConfigService.parseComposeFileAndPopulateENVs(composeFilesData[0], fullRepo, clusterName, bigPoppaUser, filePaths[0])
            .then(octobearInfo => {
