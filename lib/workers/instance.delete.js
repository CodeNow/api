...
function InstanceDeleteWorker (job) {
  ...
  return joi.validateOrBoomAsync(job, schema)
    ...
    .then(function () {
      ...
      return Instance.markAsDeletedByIdAsync(job.instanceId)
    })
    ...
    .then(function (instance) {
      log.info(logData, 'instance.delete - mark forks as deleted')
      return Instance.markAsDeletedByParentAsync(instance.shortHash).return(instance)
    })
    .then(function (instance) {
      log.info(logData, 'instance.delete - instance.container.delete command')
    ...
    .then(function (instance) {
      ...
      return Promise.fromCallback(function (cb) {
        instance.removeSelfFromGraph(cb)
      }).return(instance)
    })
    .then(function (instance) {
