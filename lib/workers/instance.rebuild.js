  ...
  return joi.validateOrBoomAsync(job, schema)
    ...
    .then(function (instance) {
      return Promise.fromCallback(function (cb) {
        ...
        log.info(put({ buildId: buildId, instance: instance }, logData), 'InstanceRebuildWorker build deep copy')
    ...
    .then(function (data) {
      log.info(put({ data: data }, logData), 'InstanceRebuildWorker build deep copied. building')
      return Promise.fromCallback(function (cb) {
    ...
    .then(function (data) {
      log.info(put({ data: data }, logData),
