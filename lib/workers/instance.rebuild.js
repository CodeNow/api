...
function InstanceRebuildWorker (job) {
  ...
  return joi.validateOrBoomAsync(job, schema)
    ...
    .then(function (instance) {
      log.trace(logData, 'InstanceRebuildWorker - find instance')
      return Promise.fromCallback(function (cb) {
    ...
    .then(function (instance) {
      return Promise.fromCallback(function (cb) {
        ...
        log.trace(put({ buildId: buildId, instance: instance }, logData), 'InstanceRebuildWorker build deep copy')
    ...
    .then(function (data) {
      log.trace(put({ data: data }, logData), 'InstanceRebuildWorker build deep copied. building')
      return Promise.fromCallback(function (cb) {
    ...
    .then(function (data) {
      log.trace(put({ data: data }, logData),
        'InstanceRebuildWorker build was build. Update instance')
      return Promise.fromCallback(function (cb) {
        var buildId = keypather.get(data, 'build._id')
