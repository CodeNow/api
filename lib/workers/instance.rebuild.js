        ...
        .then(function (instanceCreatorUser) {
          ...
          if (!accessToken) {
            ...
            throw new WorkerStopError(
              ...
              { job, intanceCreatorGithubId: instance.createdBy.github }
            )
          }
          ...
          .catch(function (err) {
            if (err.message.match(/whitelist/ig)) {
              ...
              throw new WorkerStopError(
                'Unable to login to Runnable client. Does the instance creator still have access to a whitelisted org?', { job }
              )
            }
            throw err
          })
