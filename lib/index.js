...
if (process.env.ROLLBAR_KEY) {
  rollbar.init(process.env.ROLLBAR_KEY, {
    environment: process.env.ROLLBAR_OPTIONS_ENVIRONMENT,
    branch: process.env.ROLLBAR_OPTIONS_ENVIRONMENT,
    root: process.env.ROLLBAR_OPTIONS_ROOT
  });
}
