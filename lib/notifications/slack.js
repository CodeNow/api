...
Slack.prototype.notifyOnNewBranch = function (gitInfo, cb) {
  ...
  var message = {
    text: this._createServerSelectionUrl(instanceOwnerName, gitInfo)
  };
...
Slack.prototype._createAutoUpdateText = function (gitInfo, instances) {
  var text = 'Your changes (' + gitInfo.headCommit.message + ') to ';
...
Slack.prototype._createServerSelectionUrl = function (owner, gitInfo) {
