...
/**
 * Quick helper to generate date string in format sortable by loggly
 */
function generateLogglyDateString(d) {
  // EX: "2015-10-21 13:41:45.186"
...
var serializers = put(bunyan.stdSerializers, {
  tx: function () {
    ...
    runnableData.txTimestamp = generateLogglyDateString(new Date());
    return runnableData;
  },
  req: function (req) {
    return {
