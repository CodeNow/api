...
error.logErrKeyAndNextMw = function (keypath) {
  return function (req, res, next) {
    error.logIfErr(keypather.get(req, keypath), req);
    next();
  };
};
