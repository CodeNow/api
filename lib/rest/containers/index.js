...
module.exports = function (baseUrl) {
  ...
  var updateContainer =
    series(
      ...
      or(me.isOwnerOf('container'), me.isModerator),
      body.pickAndRequireOne('saved', 'name', 'description', 'status'),
      containers.model.set('body'),
      utils.if(body.require('status'),
        harbourmaster.commitContainer),
      containers.model.save(),
      containers.respond);

    
        // utils.if(body.equals('status', 'Committing New'),
        //   images.findByName('container.name')),
