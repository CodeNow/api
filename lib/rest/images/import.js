...
app.post('/',
  ...
  buildDockerImage('dockletResult', 'image._id'),
...
function buildDockerImage (dockIpKey, imageId) {
  return function (req, res, next) {
    ...
    console.log(tarred instanceof require('stream').Readable);

    var tag = 'http://registry.runnable.com/runnable/' + imageId.toString();
