  ...
  function (req, res) {
	...
	async.waterfall([
	  function(waterfall_cb){
	    console.log('creating container for user_id: ' + req.user_id);
	    containers.create({
	      owner: req.user_id
	    }, function(err, small){
	  ...
	  function(container, waterfall_cb){
	    console.log('container created');
	    console.log(arguments);
	    container.inheritFromImage(image, waterfall_cb);
 	  },
	  function(container, waterfall_cb){
	    console.log('container inherited from image');
	    req.container = container;
   	    req.image = image;
	    harbourmaster.createContainer(req, {}, function(err, response){
   	      waterfall_cb();
	    });
          }
