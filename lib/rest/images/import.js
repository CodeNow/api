...
app.post('/github',
  ...
  images.create({
    owner: 'user_id',
    name: 'github import ' + 'query.githubUrl',
    port: 80
  }),
  images.model.createFromGithub('query.githubUrl', 'query.stack'),
  images.model.addTag('query.stack'),
  images.model.addSelfToRevisions(),
  images.model.save(),
  me.model.voteOn('image'),
  containers.create({
    owner: 'user_id'
  }),
  ...
  files.sync,
  images.model.set({files: 'container.files'}),
  images.model.save(),
  images.respond);
