...
app.get('/',
  ...
  query.ifExists('channel',
    ...
    channels.checkFound,
    query.set('tags.channel', 'channel._id'), // override default
    query.unset('channel'),
...
app.del(path.join(baseUrl, ':imageId'),
  params.isObjectId64('imageId'),
  params.decodeId('imageId'),
  or(me.isUser, me.isModerator),
  containers.findById('params.imageId', { _id: 1 }),
  containers.checkFound,
  or(me.isOwnerOf('container'), me.isModerator),
  containers.removeById('params.imageId'),
