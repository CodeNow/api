...
// list all projects
app.get('/',
  // TODO: we are going to need this - replaces image (and image feed)
...
app.post('/',
  ...
  // TODO: do we need/want any name validation here?
  ...
  project.addContexts,
  // TODO: we don't really want to respond with just the projects...
