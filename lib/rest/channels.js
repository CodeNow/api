...
app.get('/channels', function (req, res) {
  ...
  if (req.query.name != null) {
    ...
    channels.mostPopAffectedByUser(req.domain, Math.min(count, 5), req.query.userId, sendJSON);
  } else if (req.query.badges != null) {
    channels.leaderBadgesInChannelsForUser(req.domain, Math.min(count, 5), [].concat(req.query.channelIds), req.query.userId, sendJSON);
  } else {
