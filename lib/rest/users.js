...
module.exports = function (parentDomain) {
  ...
  app.post('/token', function (req, res) {
    if (req.body.username == null && req.body.email == null) {
      ...
      users.loginUser(req.domain, identity, req.body.password, req.domain.intercept(function (err, user_id) {
        ...
        form.parse(req, req.domain.intercept(function (fields, files) {
          ...
          runnables.readFile(req.domain, req.user_id, req.params.id, req.params.fileid, req.domain.intercept(function (root) {
            if (!root.dir) {
              ...
              }, req.domain.intercept(function (err, files) {
                return res.json(200, files);
              }));
            }
          }));
  ...
  var deletefile = function (req, res) {
    ...
    runnables.deleteFile(req.domain, req.user_id, req.params.id, req.params.fileid, recursive, req.domain.intercept(function (err) {
