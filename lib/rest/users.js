...
// app.get('/me/votes', tokens.hasToken, getvotes);
// app.get('/:userid/votes', tokens.hasToken, users.fetchUser, getvotes);

// app.post('/me/votes', tokens.hasToken, postvote);
// app.post('/:userid/votes', tokens.hasToken, users.fetchUser, postvote);

// app.del('/me/votes/:voteid', tokens.hasToken, removevote);
// app.del('/:userid/votes/:voteid', tokens.hasToken, users.fetchUser, removevote);
