...
module.exports = new ponos.Server({
  ...
  tasks: {
    ...
    'cluster.sibling-instance.create': require('workers/cluster.sibling-instance.create'),
  ...
  events: {
    ...
    'cluster.created': require('workers/cluster.created'),
    'cluster.parent-instance.created': require('workers/cluster.parent-instance.created'),
