...
var utils = module.exports = {
  ...
  formatFieldFilters: function () {
    return function (req, res, next) {
      if (req.query.ignoredFields) {
        try {
          req.query.ignoredFields = JSON.parse(req.query.ignoredFields);
        } catch (e) {
          return next();
        }
      } else {
      ...
      if (!Array.isArray(req.query.ignoredFields)) {
        req.query.ignoredFields = [req.query.ignoredFields];
      }
      req.ignoredFields = req.query.ignoredFields;
      next();
    };
  },
