/**
 * @module lib/middlewares/apis/container-fs
 */
'use strict';
...
module.exports = {
  ...
  handleList: function (req, res, next) {
    ...
    containerFs.list(container, path, etag, function(err, content) {
  ...
  handleGet: function (req, res, next) {
    ...
    containerFs.get(container, path, etag, function(err, content) {
      if(err) { return next(err); }
