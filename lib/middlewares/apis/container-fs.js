...
module.exports = {
  checkParams: function (req, res, next) {
    ...
    var container = req.environment.findContainerById(req.params.containerId);

    req.param.container = {};
    req.param.container.container = container.dockerContainer;
    req.param.container.host = container.dockerHost;
