...
passport.deserializeUser(function (userId, done) {
  UserService.getMongoUserByIdWithBigPoppaUser(userId)
    .asCallback(done)
})
  ...
  function updateOrCreateUser (user, cb) {
    ...
    if (user && user._id) {
      ...
      user.save(function (err) {
        ...
        UserService.getMongoUserByGithubIdWithBigPoppaUser(profile.id)
          .asCallback(cb)
      })
    } else {
      ...
      User.create(data, function (err) {
        ...
        UserService.getMongoUserByGithubIdWithBigPoppaUser(profile.id, cb)
          .asCallback(cb)
      })
    }
  }
