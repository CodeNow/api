...
var GITHUB_CLIENT_ID = process.env.GIT_HUB_CLIENT_ID;
var GITHUB_CLIENT_SECRET = process.env.GIT_HUB_CLIENT_SECRET;
var GITHUB_CALLBACK_URL = process.env.GIT_HUB_CALLBACK_URL;
var GITHUB_SCOPE = process.env.GIT_HUB_SCOPE;
...
passport.use(new GitHubStrategy({
  ...
  function(accessToken, refreshToken, profile, done) {
    ...
    function updateOrCreateUser (user, primaryEmail, cb) {
      ...
      var username = user.username || profile.username;
      var update = {
        $set: {
