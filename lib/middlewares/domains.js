...
function getRunnableData (req) {
  ...
  runnableData.userGithubUsername = runnableData.userGithubUsername ||
    keypather.get(req, 'sessionUser.accounts.github.username');
  runnableData.userGithubId = runnableData.userGithubId ||
    keypather.get(req, 'sessionUser.accounts.github.id');
  runnableData.userGithubEmail = runnableData.userGithubEmail ||
    keypather.get(req, 'sessionUser.email');
  return runnableData;
}
