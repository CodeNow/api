...
function ClassMiddleware (key, Model) {
  ...
  var self = this;
  this.model = {};
  Object.keys(Model.prototype.prototype.prototype)
    .filter(valIsFunction(Model.prototype.prototype.prototype))
    .forEach(createMiddleware);

  Object.keys(Model.prototype.prototype)
    .filter(valIsFunction(Model.prototype.prototype))
    .forEach(createMiddleware);
