...
module.exports = function (req, res, next) {
  console.log(req.headers,"xoxoxo")
  ...
  if (req.headers['x-forwarded-proto'] == 'https' && req.headers['user-agent'] == 'ELB-HealthChecker/2.0') {
    res.status(200)
    return res.end()
  }

  if (!req.isInternalRequest && req.headers['x-forwarded-proto'] !== 'https') {
