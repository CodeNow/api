...
function cleanup () {
  messenger.removeListener('runnable:docker:docker_daemon_down', dockerEvents.handleDockerDaemonDown);
  messenger.removeListener('runnable:docker:docker_daemon_up', dockerEvents.handleDockerDaemonUp);
  messenger.removeListener('runnable:docker:die', dockerEvents.handleContainerDie);
}
