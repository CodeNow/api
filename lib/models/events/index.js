...
var handleContainerDieEvent = handleDockerEvent.bind(null, dockerEvents.handleContainerDie);
...
function listen (errorHandler) {
  ...
  messenger.on('runnable:docker:die', handleContainerDieEvent.bind(null, errorHandler));
}
