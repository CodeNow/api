...
function cleanup () {
  messenger.removeListener('runnable:docker:docker_daemon_down', dockerEvents.handleDockerDown);
  messenger.removeListener('runnable:docker:docker_daemon_up', dockerEvents.handleDockerUp);
