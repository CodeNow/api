...
HipacheHosts.prototype.createRouteForContainerPort =
  function (ownerUsername, instance, container, containerPort, cb) {
    ...
    var key = ['frontend:',
      instance.name, '-', ownerUsername, '-', containerPortNumber, '.', process.env.DOMAIN
    ].join('').toLowerCase();
...
HipacheHosts.prototype.createRoutesForInstance = function (ownerUsername, instance, cb) {
  if (!instance.containers || instance.containers.length === 0) {
    return cb(Boom.badRequest('Instance does not have any containers'));
  }
  async.each(instance.containers,
    this.createRoutesForContainer.bind(this, ownerUsername, instance),
    cb);
};
...
HipacheHosts.prototype.removeRoutesForInstance = function (ownerUsername, instance, cb) {
  async.each(instance.containers,
    this.removeRoutesForContainer.bind(this, ownerUsername, instance),
    cb);
};
