...
// Export and promisify the UserWhitelist model
var UserWhitelist = module.exports = mongoose.model('UserWhitelist', UserWhitelistSchema)
Promise.promisifyAll(UserWhitelist)
Promise.promisifyAll(UserWhitelist.prototype)
