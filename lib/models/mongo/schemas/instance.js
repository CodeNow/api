...
var InstanceSchema = module.exports = new Schema({
  ...
  imagePull: {
    ...
    // sessionUser and ownerUsername are needed
    //   in instance-container-create worker.
    // This data is set in pull-instance-image, and
    //   on-instance-imagee-pull reads this data to
    //   create a instance-container-create job.
    sessionUser: {
      type: {
        github: {
          type: Number
...
InstanceSchema.index({
  'imagePull.dockerHost': 1,
  'imagePull.dockerTag': 1
})
