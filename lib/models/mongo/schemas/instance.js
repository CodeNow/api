...
var AppCodeVersionsSchema = require('models/mongo/schemas/context-version').AppCodeVersionsSchema;
...
var InstanceSchema = module.exports = new Schema({
  ...
  contextVersionAppCodes: {
    type: [{
      contextVersion : {
        type: ObjectId,
        ref: 'ContextVersion',
        required: 'Instance ContextVersionAppCodes require an Id',
        validate: validators.objectId({model:'Instance', literal: 'ContextVersionAppCodes'})
      },
      appCodeVersions: [AppCodeVersionsSchema]
    }]
  },
  outputViews: {
    type: [{
