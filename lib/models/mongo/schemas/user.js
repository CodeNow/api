...
UserSchema.virtual('isModerator').get(function () {
  log.trace('GET isModerator')
  return this.permissionLevel >= 5
})
UserSchema.virtual('bigPoppaUser').get(function () {
  return this._bigPoppaUser || null
}).set(function (bigPoppaUser) {
  this._bigPoppaUser = bigPoppaUser
})
