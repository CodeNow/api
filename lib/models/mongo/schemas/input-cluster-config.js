...
const InputClusterConfigSchema = new Schema({
  ...
  lowerRepo: {
    // This is a lowerCase Username/Repository where this file belongs
    required: 'Input Cluster Config requires a lowerRepo',
    type: String
  },
  branch: {
    // This is a branch where this file belongs
    required: 'Input Cluster Config requires a branch',
    type: String
  },
  lowerBranch: {
    // This is a lowerCase branch where this file belongs
