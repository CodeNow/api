...
var ContextVersionSchema = module.exports = new Schema({
  ...
  createdBy: {
    type: {
      // TODO remove during BP migration
      github: {
        type: Number
      },
      bigPoppa: {
  ...
  buildDockerContext: String, // path to docker build context
  /** type: object */
  build: {
...
ContextVersionSchema.virtual('isBuildSuccessful').get(function () {
  return this.build.completed && !this.build.failed
})
