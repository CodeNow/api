...
var S_INVALID_STATE = ' is an invalid state'
...
module.exports.commonValidators = {
  ...
  cvState: function (input) {
    input.invalidCheck = S_INVALID_STATE
    input.validator = 'isIn'
    input.arguments = [ 'build started', 'build starting' ]
    return invalidCheck(input)
  }
}
