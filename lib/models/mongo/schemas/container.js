...
//  console.log('** CONTAINER *** %s has been validated (but not saved yet)', doc);
//});
//ContainerSchema.post('save', function (doc) {
//  console.log('** CONTAINER *** %s has been saved', doc);
//});
//ContainerSchema.post('remove', function (doc) {
//  console.log('** CONTAINER *** %s has been removed', doc);
//});