...
var BuildSchema = module.exports = new Schema({
  ...
  // SourceMechanism (Auto-commit, user clicked,...)
//  /** type: string */
//  name: {
//    type: String
//  },
...
//  console.log('** BUILD *** %s has been validated (but not saved yet)', doc);
//});
//BuildSchema.post('save', function (doc) {
//  console.log('** BUILD *** %s has been saved', doc);
//});
//BuildSchema.post('remove', function (doc) {
//  console.log('** BUILD *** %s has been removed', doc);
//});