...
var ContextSchema = module.exports = new Schema({
  ...
  displayName: {
    type: String,
    validate : validators.alphaNumName(({model: "Context", literal: "Display Name", passIfEmpty: true}))
  },
  /** @type string */
  description: {
    type: String,
    validate : validators.description(({model: "Context", literal: "Description", passIfEmpty: true}))
  },
