...
var ContextSchema = module.exports = new Schema({
  ...
  name: {
    ...
    validate : validators.urlSafe({model: "Context", literal: "Name", parentObject: this})
  },
  /** @type string */
  displayName: {
    type: String,
...
//  console.log('*** CONTEXT ****  %s has been validated (but not saved yet)', doc);
//});
//ContextSchema.post('save', function (doc) {
//  console.log('*** CONTEXT ****  %s has been saved', doc);
//});
//ContextSchema.post('remove', function (doc) {
//  console.log('*** CONTEXT ****  %s has been removed', doc);
//});