 ...
 * @param {ObjectId=}           clusterOpts.parentInputClusterConfigId - Highest Parent of this cluster
 *
 * @returns {Promise.<T>}
 */
InputClusterConfigSchema.statics.updateConfig = function (autoIsolationConfig, clusterOpts) {
  ...
  return InputClusterConfigSchema.findActiveByAutoIsolationId(autoIsolationConfig._id)
