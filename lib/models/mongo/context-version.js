  ...
  return Promise.try(function () {
    ...
    .then(function (contextVersion) {
      if (keypather.get(contextVersion, 'build.started')) {
        ...
        return this._startBuild(sessionUser, opts, domain)
      }
    })
}

ContextVersionSchema.methods._startBuild = function (sessionUser, opts, domain) {
  var logData = {
    tx: true,
    _id: this._id,
    opts: opts
  ...
  return this.setBuildStartedAsync(sessionUser, opts)
    ...
    .then(function () {
      var oldBuildId = keypather.get(this, 'build._id.toString()')
      if (!opts.noCache) {
