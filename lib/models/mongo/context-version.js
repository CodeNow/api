...
ContextVersionSchema.methods.getUserContainerMemoryLimit = function () {
  ...
  if (this.userContainerMemoryInBytes) {
    log.trace(put({
      userContainerMemory: this.userContainerMemoryInBytes
    }, logData), 'getUserContainerMemoryLimit - Custom container memory overridden.')
    return this.userContainerMemoryInBytes
  }


  return process.env.CONTAINER_REPO_MEMORY_LIMIT_BYTES

  //var isRepo = this.getMainAppCodeVersion()
  //
  //log.trace(put({
  //  mainACV: isRepo,
  //  CONTAINER_REPO_MEMORY_LIMIT_BYTES: process.env.CONTAINER_REPO_MEMORY_LIMIT_BYTES,
  //  CONTAINER_NON_REPO_MEMORY_LIMIT_BYTES: process.env.CONTAINER_NON_REPO_MEMORY_LIMIT_BYTES
  //}, logData), 'getUserContainerMemoryLimit - Is it a repo?')
  //
