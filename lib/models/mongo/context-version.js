...
/**
 * Set the dockRemoved flag to false, and set the dockRemovedConfirmedByUser to true if dockRemoved was true.
 * @param {function} cb
 */
ContextVersionSchema.methods.handleRecovery = function (cb) {
  this.update({
    $set: {
      dockRemoved: false,
      dockRemovedConfirmedByUser: this.dockRemoved
    }
  }, cb)
}
