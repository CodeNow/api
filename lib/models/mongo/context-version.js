 ...
 * @return {Promise}
 */
ContextVersionSchema.statics.updateAndGetSuccessfulBuild = (buildId, dockerImage) => {
  var logger = log.child({method: 'updateAndGetSuccessfulBuild'})
  logger.info('updateAndGetSuccessfulBuild called')
