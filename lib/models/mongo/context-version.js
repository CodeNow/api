 ...
 * @param {Object[]} context version
 * @returns {String} memory in bytes to limit to
 */
ContextVersionSchema.statics.getUserContainerMemoryLimit = function (contextVersion) {
  var logData = {
    tx: true,
  ...
  if (contextVersion.userContainerMemory) {
    return contextVersion.userContainerMemory
  }

  var isRepo = ContextVersion.getMainAppCodeVersion(contextVersion.appCodeVersions)
  return isRepo
