...
ContextVersionSchema.methods.getUserContainerMemoryLimit = function () {
  ...
  if (this.userContainerMemory) {
    log.trace(put({
      userContainerMemory: this.userContainerMemory
    }, logData), 'getUserContainerMemoryLimit - Custom container memory overridden.')
    return this.userContainerMemory
  }

  var isRepo = ContextVersion.getMainAppCodeVersion(this.appCodeVersions)
