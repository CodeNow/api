...
ContextVersionSchema.statics.addGithubRepoToVersion = function (sessionUser, contextVersionId, repoInfo) {
  ...
  var githubToken = sessionUser.accounts.github.accessToken
 ...
 */
ContextVersionSchema.statics.createParentAppcodeVersion = function (sessionUser, repoName) {
  var githubToken = sessionUser.accounts.github.accessToken
  var github = new Github({ token: githubToken })
  ...
  .then((githubRepoInfo) => {
    ...
    .then((githubInfo) => {
      return {
        ...
        privateKey: githubInfo.eys.privateKey
      }
    })
  })
}
