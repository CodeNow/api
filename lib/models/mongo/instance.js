...
InstanceSchema.statics.setContainerError = function (instanceId, containerId, errMsg) {
  ...
  var setData = {
    ...
    'container.inspect.Starting': false,
    'container.inspect.Running': false,
    'container.inspect.Paused': false,
    'container.inspect.Restarting': false,
    'container.inspect.OOMKilled': false,
    'container.inspect.Dead': false,
    'container.inspect.Error': errMsg
  }
  var log = logger.log.child({
    instanceId: instanceId,
    containerId: containerId,
