...
InstanceSchema.methods.generateGraphNode = function () {
  var context = keypather.get(this, 'contextVersion.context.toString()')
  var node = {
    label: 'Instance',
    props: {
      id: this.id.toString(),
      ...
      'contextVersion_context': context // eslint-disable-line quote-props
...
InstanceSchema.methods.upsertIntoGraph = function (cb) {
  log.info({
    tx: true,
    instance: instance
  }, 'InstanceSchema.methods.upsertIntoGraph')
  var client = new Graph()
  var node = this.generateGraphNode()
