 ...
 * @param {Object} isolation Isolation object to associate the Instance.
...
InstanceSchema.methods.isolate = function (isolationId, isMaster) {
  return Promise.bind(this)
    ...
    .then(function (updateOpts) {
      this.isolated = isolationId
      this.isIsolationGroupMaster = !!isMaster
      return Promise.fromCallback(this.save.bind(this))
    })
}
