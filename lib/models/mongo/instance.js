...
InstanceSchema.statics.getMainBranchName = function (instance) {
  ...
  if (instance.isNonRepoContainer) {
    return null
  }
  var mainAppCodeVersion = ContextVersion.getMainAppCodeVersion(
    keypather.get(instance, 'contextVersion.appCodeVersions')
  )
  return keypather.get(mainAppCodeVersion, 'lowerBranch')
}
/**
