...
/**
 * Find all unlocked instances that match contextId
 *
 * @param  {String}   contextId - ObjectId of context to use (optional)
 * @resolve {Promise}
 * @returns {Array} array of found instances
 */
InstanceSchema.statics.findUnlockedInstancesByContext = function (contextId) {
  var log = logger.log.child({
    contextId,
    method: 'InstanceSchema.statics.findUnlockedInstancesByContext'
  })
  log.info('findUnlockedInstancesByContext called')
  var query = {
