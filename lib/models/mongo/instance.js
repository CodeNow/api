...
var isObjectId = require('101/is-object');
...
InstanceSchema.statics.addDefaultIsolationOpts = function (query) {
  ...
  if (query.$or) {
    ...
    query.$or = query.$or.concat(defaults.$or);
  } else {
    query.$or = defaults.$or;
  }
  return query;
};
...
InstanceSchema.methods.generateGraphNode = function () {
  var node = {
    ...
    props: {
      ...
      // eslint dislikes quoted props and non-camelcase values. such contradiction
