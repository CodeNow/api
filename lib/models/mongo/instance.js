...
InstanceSchema.statics.findOneByBuildContainerId = function (buildContainerId, cb) {
  var log = logger.log.child({
    buildContainerId,
    method: 'InstanceSchema.statics.findOneByBuildContainerId'
  })
  log.info('called')
  this.findOne({
    'contextVersion.build.dockerContainer': buildContainerId
  }, cb)
}
