...
/**
 * Does a regex check to see if the instance's hostname
 * @param hostname
 * @param instance
 * @returns {boolean}
 */
function doesStringContainInstanceHostname (hostname, instance) {
...
function findMatchingInstanceByHostname (hostname, instanceList) {
  return find(instanceList, function (instance) {
    return doesStringContainInstanceHostname(hostname, instance)
  })
}
