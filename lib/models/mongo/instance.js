 ...
 *
 */
InstanceSchema.methods.modifyUnsetImagePull = function (dockerHost, dockerTag, cb) {
  Instance.findOneAndUpdate({
    _id: this._id,
    'imagePull.dockerHost': dockerHost,
...
bluebird.promisifyAll(Instance.prototype)
