...
BuildSchema.statics.findPopulated = function (user, query, cb) {
  var Build = this;
  Build
    .find(query)
...
BuildSchema.statics.findOnePopulated = function (user, query, cb) {
  var Build = this;
  Build
    .findOne(query)
    .populate('contextVersions')
...
// BuildSchema.methods.getGithubUsernames = function (user, cb) {
//
// };
