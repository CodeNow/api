...
// BuildSchema.methods.dedupeContextVersions = function (cb) {
//   var ContextVersion = require('mongo/models/context-version');
//   async.map(this.contextVersions, function (contextVersionId, cb) {
//     ContextVersion.findById(contextVersionId, function (err, contextVersion) {
//       if (err) { return cb(err); }
//       contextVersion.dedupe(function () {
