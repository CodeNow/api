 ...
 */
PullRequest.prototype.buildStarted = function (gitInfo, targetUrl) {
  debug('buildStarted', formatArgs(arguments));
  var description = 'This commit is building on Runnable.';
  this._buildStatus(gitInfo, 'pending', description, targetUrl);
};
 ...
 * @param  {String}   targetUrl     url pointing to the runnable server
 */
PullRequest.prototype.buildSucceeded = function (gitInfo, targetUrl) {
  debug('buildSucceeded', formatArgs(arguments));
  var description = 'This commit is ready to run on Runnable.';
  this._buildStatus(gitInfo, 'success', description, targetUrl);
};
 ...
 * @param  {String}   targetUrl     url pointing to the runnable server
 */
PullRequest.prototype.buildErrored = function (gitInfo, targetUrl) {
  debug('buildErrored', formatArgs(arguments));
  var description = 'This commit has failed to build on Runnable.';
  this._buildStatus(gitInfo, 'error', description, targetUrl);
};
