 ...
 * @param {Number} githubUserId   user that will be the creator of the instance
 * @param {String} branch         branch name that will be appended to the name of the new instance
 * @param {Function} cb           standard callback
 */
Runnable.prototype.forkMasterInstance = function (masterInst, buildId, githubUserId, branch, cb) {
