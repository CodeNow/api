...
var Instance = require('models/mongo/isnatnce');
 ...
 * @param {Function} cb              standard callback
 */
Runnable.prototype.destroyForkedIstances = function (masterInstance, cb) {
  debug('destroyForkedIstances', formatArgs(arguments));
