...
Runnable.prototype.copyInstance = function (sessionUser, build, parentInstance, newProps, cb) {
  ...
  if (keypather.get(body, 'owner.github') ===
      process.env.HELLO_RUNNABLE_GITHUB_ID) {
    // if forking from HELLO_RUNNABLE user, assign currently
    // authenticated user's github id
    body.owner.github = sessionUser.accounts.github.id;
    body.build.owner.github = sessionUser.accounts.github.id;
  }
