...
Runnable.prototype.updateInstance = function (id, opts, cb) {
  ...
  update();
  function update () {
    origUpdateInstance.call(this, id, opts, function (err) {
      if (err) {
...
Runnable.prototype.waitForInstanceDeployed = function (instance, cb) {
  var jsonInstance = instance.toJSON ?
    instance.toJSON() :
    instance;
  var self = this;
  var retries = 0;
  ...
  function checkDeployed () {
    self.newInstance(jsonInstance.shortHash)
