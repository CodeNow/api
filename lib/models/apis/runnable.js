...
Runnable.prototype.forkMasterInstance = function (masterInstance, buildId, branch, cb) {
  debug('forkMasterInstance', formatArgs(arguments));
  var body = {
    parent: masterInstance.shortHash,
    build: buildId,
    name: masterInstance.name + '-' + branch,
    // TODO we need to take owner from git
    owner: 429706 //masterInstance.owner
  };
  this.createInstance(body, cb);
}
