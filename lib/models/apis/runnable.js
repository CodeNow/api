 ...
 * @return null
 */
Runnable.prototype.workerContainerCreate = function (instanceId, buildId, container, cb) {
  this.client.request.post(url.format({
    host: process.env.FULL_API_DOMAIN,
    pathname: '/workers/create-container'
  }), {
