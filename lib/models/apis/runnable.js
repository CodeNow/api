 ...
 */
Runnable.prototype.autoDeployBuildToInstance = function (instanceHash, buildId, cb) {
  debug('autoDeployBuildToInstance', formatArgs(arguments));
  Instance.isAutoDeployOn(instanceHash, function (err, on) {
    ...
    this.updateInstance(instanceHash, payload, cb);
  }.bind(this));
};
