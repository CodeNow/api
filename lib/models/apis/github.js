 ...
 * @return {Object}
 *         {String} .deployKeys.publicKey
 *         {String} .deployKeys.privateKey
 *         {String} .repoInfo.default_branch
 */
Github.prototype.createHooksAndKeys = function (repoName) {
  return this.getRepoAsync(repoName)
  .then((repoInfo) => {
    return this.createRepoHookIfNotAlreadyAsync(repoName)
    .then(() => {
      return this.addDeployKeyIfNotAlreadyAsync(repoName)
    })
    .then((deployKeys) => {
      return { deployKeys, repoInfo }
    })
  })
}
