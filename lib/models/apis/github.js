...
Github.prototype.getOrgRepositories = function (orgname, cb) {
...
Github.prototype.getUserRepositories = function (username, cb) {
...
Github.prototype.getUsernameForCommit = function (repo, commit, cb) {
  this.getCommit(repo, commit, function (err, commit) {
    if (err) { cb(err); }
    else { cb(null, commit.committer.login); }
  });
};
