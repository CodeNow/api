...
Docker.prototype.startImageBuilderAndWait = function (sessionUser, version, container, cb) {
  ...
  self.startContainer(container, { Binds: binds }, function (err) {
    ...
    container.wait(function (err, res) {
      getContainerLogs(self, container, function (logError, buildLogData) {
        if (logError) {
          cb(logError);
        } else if (err) {
        ...
        if (buildFailed) {
          ...
          if (res.StatusCode) {
            ...
            return self.handleError(cb, 'build failed to build', { docker: {
              containerId: container.Id,
              versionId: version._id,
              log: buildLogData
            }})(
...
function getContainerLogs(self, container, cb) {
