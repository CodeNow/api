...
var mapObj = require('object-loops/map');
...
Docker.prototype.createImageBuilder = function (opts, cb) {
  ...
  var buildContainerLabels = this._createImageBuilderLabels({
    ...
    dockerTag: Docker.getDockerTag(opts.contextVersion),
...
Docker.prototype._createImageBuilderLabels = function (opts) {
  ...
  mapObj(buildContainerLabels, function (val, key, obj) {
    obj[key] = isFunction(keypather.get(val, 'toString')) ? val.toString() : val;
  });
