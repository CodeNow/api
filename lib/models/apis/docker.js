...
Docker.prototype.startUserContainer = function (container, ownerId, opts, cb) {
  logger.log.info({
    ...
    container: container,
    opts: opts
  }, 'Docker.prototype.startUserContainer');
 ...
 * @param container containerId string, docker container, or mongo container object
...
Docker.prototype.inspectContainer = function (container, cb) {
  ...
  var containerId = isString(container) ? container :
