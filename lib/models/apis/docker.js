 ...
 * `TIMEOUT` error trying to talk to Swarm
...
Docker.prototype.getLogsAndRetryOnTimeout = function (containerId, tail, cb) {
  ...
  operation.attempt(function (currentAttempt) {
    self.getLogs(containerId, tail, function (err, stream) {
      if (err) {
        var origCode = keypather.get(err, 'custom.err.code')
        if (origCode === 'TIMEOUT') {
...
Docker.prototype.execContainer = function (containerId, cb) {
  ...
  var self = this
  function faultTolerantExec (cb) {
      var operation = retry.operation()
      operation.attempt(function (currentAttempt) {
        this._containerAction(containerId, 'exec', opts, function (err, exec) {
