...
Docker.prototype._createImageBuilderEnv = function (opts) {
  ...
  if (organization && organization.privateRegistryUrl && organization.privateRegistryUsername) {
    ...
    // TODO fix this after anands change process.env.USER_VAULT_ENDPOINT
    env.push('RUNNABLE_VAULT_ENDPOINT=' + 'http://aa8364af12f5a11e7bb9e02301ded9ea-905956029.us-west-2.elb.amazonaws.com:8200')
