 ...
 * @param {Object} opts.ownerGitHubUsername - Cvs owner's github username
 ...
 * @param  {Object}   opts.ownerGitHubUsername instance/contextVersion's owner's username
 ...
 * @param  {Object} opts.sessionUser
 * @param  {String} opts.ownerGitHubUsername
...
Docker.prototype._createUserContainerLabels = function (opts, cb) {
  ...
  joi.validateOrBoom(map(opts, toJSON), joi.object({
    ...
    var labels = {
      ...
      contextVersionId: cv._id.toString(),
      ownerGitHubUsername: opts.ownerGitHubUsername.toString(),
