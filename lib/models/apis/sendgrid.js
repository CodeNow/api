...
SendGridModel.prototype.inviteAdmin = function (recipient, sessionUser, organizationId, cb) {
  ...
  Promise.props({
    ...
    .then(function (data) {
      return self.sendEmail(data.recipient, sessionUser, data.organization, {
...
SendGridModel.prototype.inviteUser = function (recipient, sessionUser, organizationId, cb) {
  ...
  Promise.props({
    ...
    .then(function (data) {
      ...
      return self.sendEmail(recipient, sessionUser, data.organization, {
        email: recipient.email,
        subject: 'Check out Runnable!',
        body: INVITE_BODY,
        template: 'ee14348c-1f56-47c3-af9e-d3d55d749494',
...
SendGridModel.prototype.sendEmail = function (recipient, sessionUser, organization, emailOptions) {
  logger.log.info({
    tx: true,
