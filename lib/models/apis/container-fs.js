/**
 * @module lib/models/apis/container-fs
 */
'use strict';
...
function createRequeset(method, container, path, opts) {
  ...
  if (opts && typeof opts.etag === 'string') {
...
module.exports  = {
  list: function (container, pathToDir, etag, cb) {
    // path must have trailing slash to ensure this is a file
    var start = new Date();
    request(
      createRequeset('GET', container, pathModule.join(pathToDir,'/'), { etag: etag }),
      function (err, res) {
  ...
  get: function (container, path, etag, cb) {
    var start = new Date();
    request(
      createRequeset('GET', container, path, { etag: etag }),
      function (err, res) {
