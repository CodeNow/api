...
module.exports  = {
  list: function (container, pathToDir, cb) {
    ...
    var start = new Date();
    var req = createRequeset('GET', container, pathModule.join(pathToDir, '/'));
    request(
      req,
      function (err, res) {
  ...
  get: function (container, path, cb) {
    var start = new Date();
    var req = createRequeset('GET', container, path);
    request(
      req,
      function (err, res) {
  ...
  patch: function (container, path, newObject, cb) {
    var start = new Date();
    var req = createRequeset('POST', container, path, {
      body: newObject
    });
    request(
      req,
  ...
  del: function (container, path, cb) {
    var start = new Date();
    var req = createRequeset('DELETE', container, path);
    request(
      req,
      function (err, res) {
