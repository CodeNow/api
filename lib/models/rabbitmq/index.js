...
/**
 * Enqueues a job for the given github event. This job is processed by Metis (an
 * astral sub-project) where the data is normalized and recorded in the
 * infrastructure database.
 * @param {string} type The event type.
 * @param {object} data The data body for th event.
 */
RabbitMQ.prototype.publishGithubEvent = function (type, data) {
  this.hermesClient.publish('metis-github-event', { type: type, data: data });
};
