...
RabbitMQ.prototype.connect = function () {
  ...
  this._publisher = new Publisher({
    ...
    events: [{
      ...
      name: 'image-builder.container.created',
      jobSchema: schemas.containerLifeCycleEvent
    }, {
      name: 'image-builder.container.died',
      jobSchema: schemas.containerLifeCycleEvent
    }, {
      name: 'image-builder.container.started',
      jobSchema: schemas.containerLifeCycleEvent
    }, {
      ...
      name: 'instance.container.started',
      jobSchema: schemas.containerLifeCycleEvent
    }, {
...
/**
 * create image-builder.container.created job
 * @param {Object} data job data
 */
RabbitMQ.prototype.publishContainerImageBuilderCreated = function (data) {
  this._publisher.publishEvent('image-builder.container.created', data)
}

/**
 * create image-builder.container.died job
 * @param {Object} data job data
 */
RabbitMQ.prototype.publishContainerImageBuilderDied = function (data) {
  this._publisher.publishEvent('image-builder.container.died', data)
}

/**
 * create image-builder.container.started job
 * @param {Object} data job data
 */
RabbitMQ.prototype.publishContainerImageBuilderStarted = function (data) {
  this._publisher.publishEvent('image-builder.container.started', data)
}
...
/**
 * create instance.container.died job
 * @param {Object} data job data
 */
RabbitMQ.prototype.publishInstanceContainerDied = function (data) {
  this._publisher.publishEvent('instance.container.died', data)
}
...
RabbitMQ.prototype.publishInstanceContainerStarted = function (data) {
  this._publisher.publishEvent('instance.container.started', data)
}
