...
RabbitMQ.prototype.connect = function () {
  ...
  this._publisher = new Publisher({
    ...
    events: [{
      ...
      name: 'cluster.instance.created',
      jobSchema: schemas.clusterInstanceCreated
    }, {
...
RabbitMQ.prototype.clusterInstanceCreated = function (data) {
  this._publisher.publishEvent('cluster.instance.created', data)
}

RabbitMQ.prototype.createClusterInstance = function (data) {
  this._publisher.publishTask('cluster.instance.create', data)
}
...
RabbitMQ.prototype.autoIsolationConfigCreated = function (data) {
  this._publisher.publishEvent('auto-isolation-config.created')
}
/**
