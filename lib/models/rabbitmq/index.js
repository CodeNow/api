...
var OnDockUnhealthy = require('workers/on-dock-unhealthy');
var onDockUnhealthy = new OnDockUnhealthy();
var createCount = require('callback-count');
...
RabbitMQ.prototype.loadWorkers = function () {
  ...
  this.hermesClient.subscribe('on-dock-unhealthy', function (data, cb) {
    onDockUnhealthy.handle(data, cb);
  });
};
