...
RabbitMQ.prototype.loadWorkers = function () {
  ...
  this.hermesClient.subscribe('start-image-build-container',
                              require('workers/start-image-build-container').worker);
...
RabbitMQ.prototype.unloadWorkers = function (cb) {
  ...
  this.hermesClient.unsubscribe('start-image-build-container', null, count.next);
