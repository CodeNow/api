...
RabbitMQ.prototype.connect = function () {
  ...
  this._publisher = new Publisher({
      ...
      'kart.kill',
    {
      ...
      name: 'build.container.requested',
...
RabbitMQ.prototype.buildContainerRequested = function (data) {
  this._publisher.publishEvent('build.container.requested', data)
}

RabbitMQ.prototype.applicationContainerRequested = function (data) {
  this._publisher.publishEvent('application.container.requested', data)
}
...
RabbitMQ.prototype.kartKill = function (data) {
  this._publisher.publishEvent('kart.kill', data)
}
