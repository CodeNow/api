...
RabbitMQ.prototype.loadWorkers = function () {
  ...
  var ponosTasks = this.ponosTasks = {
    ...
    'instance.deployed.notify': require('workers/instance.deployed.notify'),
...
/**
 * create a instance.deployed.notify job and insert it into queue
 * @param {Object} data
 */
RabbitMQ.prototype.notifyOnInstanceDeploy = function (data) {
  log.info({
    tx: true,
    data: data
  }, 'RabbitMQ.prototype.notifyOnInstanceDeploy')
  var requiredKeys = ['instanceId', 'cvId']
  this._validate(data, requiredKeys, 'instance.deployed.notify')
  this.hermesClient.publish('instance.deployed.notify', data)
}
