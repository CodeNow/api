...
RabbitMQ.prototype.connect = function (cb) {
  var opts = {
    ...
    publishedEvents: [
      ...
      'instance.deleted',
      'instance.updated',
      'instance.context-version.updated',
      'instance.deployed'
    ],
    queues: [
      'asg.create',
...
/**
 * create a instance-context-version-updated and insert it into queue
 * @param {Object} data
 * @param {Object} data.instance - Instance object
 * @param {Object} data.cvId - ID of new context version
 * @param {Object} data.oldCvId - ID of old context version
 */
RabbitMQ.prototype.instanceContextVersionUpdated = function (data) {
  log.info({
    tx: true,
    instance: keypather.get(data, 'instance')
  }, 'RabbitMQ.prototype.instanceContextVersionUpdated')
  var requiredKeys = [
    'instanceId',
    'contextVersionId',
    'oldContextVersionId'
  ]
  this._validate(data, requiredKeys, 'instanceContextVersionUpdated')
  this.hermesClient.publish('instance.contextVersion.updated', data)
}
