 ...
 * @param {object} githubEventData The data body for the event.
 */
RabbitMQ.prototype.publishGithubEvent = function (type, githubEventData) {
  this.hermesClient.publish('metis-github-event', {
    type: type,
    githubEventData: githubEventData
  });
};
