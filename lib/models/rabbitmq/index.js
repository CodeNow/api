...
/**
 * create container.image-builder.created job
 * @param {Object} data job data
 */
...
/**
 * create instance.container.diedgd job
 * @param {Object} data job data
 */
RabbitMQ.prototype.publishInstanceContainerDied = function (data) {
  log.info({
    job: data
  }, 'RabbitMQ.publishInstanceContainerDied')
  this._publisher.publishEvent('instance.container.died', data)
}

/**
 * create container.image-builder.died job
 * @param {Object} data job data
 */
RabbitMQ.prototype.publishContainerImageBuilderDied = function (data) {
  log.info({
    job: data
  }, 'RabbitMQ.publishContainerImageBuilderDied')
  this._publisher.publishEvent('container.image-builder.died', data)
}
...
RabbitMQ.prototype.publishContainerRemove = function (data) {
  this._publisher.publishTask('container.remove', data)
}
