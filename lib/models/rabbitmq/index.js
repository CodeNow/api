 ...
 *
 */
RabbitMQ.prototype.matchIsolationPropertyUpdates = function (data) {
  log.info({
    tx: true,
    data: data
  }, 'RabbitMQ.prototype.matchIsolationPropertyUpdates')
  var requiredKeys = [
    'isolationId',
    'repo',
    'updates',
  ...
  this._validate(data, requiredKeys, 'matchIsolationPropertyUpdates')
  this.hermesClient.publish('isolation.match-property-updates', data)
}
