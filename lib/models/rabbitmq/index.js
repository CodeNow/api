...
RabbitMQ.prototype.connect = function () {
  ...
  this._publisher = new Publisher({
    ...
    tasks: RabbitMQ.generateTaskDefinitions([
      ...
      'cluster.create',
      'cluster.delete',
      'cluster.sibling-instance.create',
      'container.delete',
    ...
    events: [{
      ...
      jobSchema: schemas.clusterCreated
    }, {
      ...
      name: 'cluster.parent-instance.created',
      jobSchema: schemas.clusterParentInstanceCreated
    }, {
      name: 'cluster.sibling-instance.created',
      jobSchema: schemas.clusterSiblingInstanceCreated
    }, {
...
RabbitMQ.prototype.clusterCreated = function (data) {
  this._publisher.publishEvent('cluster.created', data)
}
...
RabbitMQ.prototype.clusterParentInstanceCreated = function (data) {
  this._publisher.publishEvent('cluster.parent-instance.created', data)
}

RabbitMQ.prototype.clusterSiblingInstanceCreated = function (data) {
  this._publisher.publishEvent('cluster.sibling-instance.created', data)
}
RabbitMQ.prototype.createClusterSiblingInstance = function (data) {
  this._publisher.publishTask('cluster.sibling-instance.create', data)
}
