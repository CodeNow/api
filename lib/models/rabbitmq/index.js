...
/**
 * create a 'khronos:containers:delete job and insert it into queue
 * @param {Object} data
 * @param {String} data.containerId - docker containerId to delete
 * @param {String} data.dockerHost  - host of the dock this container should exist on
 *
 * @throws ValidationError when requiredKeys are not provided
 */
RabbitMQ.prototype.deleteImageBuilderContainer = function (data) {
  log.info({
    tx: true,
    data: data
  }, 'RabbitMQ.prototype.deleteInstanceContainer')
  ...
  this._validate(data, requiredKeys, 'khronos:containers:delete')
