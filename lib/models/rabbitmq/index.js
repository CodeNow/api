...
RabbitMQ.prototype.connect = function () {
  ...
  this._publisher = new Publisher({
    ...
    events: [{
      ...
      name: 'deployment.built',
      jobSchema: schemas.deploymentBuilt
    }, {
...
RabbitMQ.prototype.publishDeploymentBuilt = function (data) {
  return this._publisher.publishEvent('deployment.built', data)
}

RabbitMQ.prototype.publishDeploymentBuildComplete = function (data) {
  return this._publisher.publishTask('deployment.build.complete', data)
}
