...
RabbitMQ.prototype.connect = function () {
  ...
  this._publisher = new Publisher({
    ...
    events: [{
      ...
      name: 'docker-compose.cluster.deleted',
      jobSchema: joi.object({
...
/**
 * create a container.delete job and insert it into queue
 * @param {Object} data
 */
...
RabbitMQ.prototype.composeClusterDeleted = function (data) {
  this._publisher.publishEvent('docker-compose.cluster.deleted', data)
}
...
/**
 * create application.container.started job
 * @param {Object} data job data
 */
