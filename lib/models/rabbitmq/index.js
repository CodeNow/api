...
RabbitMQ.prototype.connect = function () {
  ...
  this._publisher = new Publisher({
    ...
    events: [{
      ...
      name: 'cluster-build.built',
      jobSchema: schemas.clusterBuildBuilt
    }, {
      ...
      jobSchema: schemas.privateKeyRequested
    }]
  })
...
RabbitMQ.prototype.cleanupCluster = function (data) {
  return this._publisher.publishTask('cluster.cleanup', data)
}
...
RabbitMQ.prototype.deleteInstanceVolumes = function (data) {
  this._publisher.publishTask('instance.volumes.delete', data)
}
...
RabbitMQ.prototype.publishOrgUserSshKeyRequested = function (data) {
  return this._publisher.publishEvent('org.user.ssh-key.requested', data)
}

RabbitMQ.prototype.publishClusterBuildBuilt = function (data) {
  return this._publisher.publishEvent('cluster-build.built', data)
}

RabbitMQ.prototype.publishClusterBuildComplete = function (data) {
  return this._publisher.publishTask('cluster-build.complete', data)
}
