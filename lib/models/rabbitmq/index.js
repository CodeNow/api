...
RabbitMQ.prototype.loadWorkers = function () {
  ...
  var ponosTasks = this.ponosTasks = {
    'container.image-builder.start': require('workers/container.image-builder.start'),
 ...
 * @param {Object} data.imagePullId pull id
 */
RabbitMQ.prototype.containerImageBuilderStart = function (data) {
  var requiredKeys = [
    'dockerContainerId',
    'dockerHost',
    'contextVersionId'
  ]
  this._validate(data, requiredKeys, 'containerImageBuilderStart')
  // toString objectIds
  data.instanceId = data.instanceId.toString()
  this.hermesClient.publish('pull-instance-image', data)
}
