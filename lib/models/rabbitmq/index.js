...
RabbitMQ.prototype.loadWorkers = function () {
  ...
  var ponosTasks = this.ponosTasks = {
    ...
    'isolation.match-commit-with-master': require('workers/isolation.math-commit-with-master'),
...
/**
 * Match the commit of the group master with all child instances with same repo
 * @param {Object} data
...
RabbitMQ.prototype.matchCommitWithIsolationMaster = function (data) {
  ...
  this.hermesClient.publish('isolation.matchCommitWithIsolationMaster', data)
}
