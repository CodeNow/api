...
RabbitMQ.startInstanceContainer = function (data) {
  ...
  _publisher.publishTask('instance.start', data)
}
...
RabbitMQ.createInstanceContainer = function (data) {
  ...
  _publisher.publishTask('instance.container.create', data)
}
...
RabbitMQ.stopInstanceContainer = function (data) {
  ...
  _publisher.publishTask('instance.stop', data)
}
 ...
 * @param {Object} data
 */
RabbitMQ.dockPurged = function (data) {
  log.info({
    ipAddress: data.ipAddress
  }, 'RabbitMQ.dockPurged')
  _publisher.publishEvent('dock.purged', data)
}
