...
RabbitMQ.prototype.unloadWorkers = function (cb) {
  ...
  if (!this.ponosServer) {
    log.warn('RabbitMQ.prototype.unloadWorkers !ponosServer')
    return cb()
  }
  var ponosTasks = this.ponosTasks
...
/**
 * Create a instance.kill job and insert it int he queue
 * @param {Object} data
 */
