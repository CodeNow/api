...
RabbitMQ.prototype.connect = function (cb) {
  ...
  this.hermesClient = require('runnable-hermes')
...
RabbitMQ.prototype.unloadWorkers = function (cb) {
  ...
  var tasks = [];
  tasks.push(function (eachCb) {

  });
  var tasks = ['on-instance-container-create', 'delete-instance'];
  var self = this;
  async.each(tasks, function (task, eachCb) {
    self.hermesClient.unsubscribe(task, null, cb);
  }, cb);
};
