...
module.exports = function (domain, token, target, cb) {
  ...
  volumes.readAllFiles(domain, token, target.file_root, ignores, exts, domain.intercept(function (allFiles) {
    allFiles.forEach(function (file) {
      var new_file = {
        name: file.name,
        path: file.path,
        dir: file.dir ? true : undefined,
        content: file.content != null ? file.content : undefined
      };
