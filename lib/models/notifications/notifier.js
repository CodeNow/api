...
if (!onGitHubPullRequestTpls[name]) {
    onGitHubPullRequestTpls[name] = createTpl('./templates/' + this.name + '_on_github_pull_request.hbs');
  }
  this.onGitHubPullRequestTpl = onGitHubPullRequestTpls[name];
}
