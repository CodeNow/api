...
function Slack (ctx, instance, user) {
  this.ctx = ctx;
...
Slack.prototype.notifyOnBuild = function (cb) {
  ...
  var SLACK_WEBHOOK_URL = 'https://hooks.slack.com/services/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';
  var slackClient = slack(SLACK_WEBHOOK_URL);
