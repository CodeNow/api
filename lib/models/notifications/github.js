...
GitHub.prototype.updatePullRequestsComments = function (instance, origInstance, cb) {
  ...
  cb = cb || noop;
  async.parallel([
    this._updatePullRequestComments.bind(this, instance, this._newMessageForLinkedBox),
    this._updatePullRequestComments.bind(this, origInstance, this._newMessageForUnLinkedBox)
  ], cb);
};
