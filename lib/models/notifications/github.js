...
GitHub.prototype.updatePullRequestsComments = function (instance, origInstance, cb) {
  ...
  cb = cb || noop;
  async.series([
    this._updatePullRequestComments.bind(this, instance, this._newMessageForLinkedBox.bind(this)),
    this._updatePullRequestComments.bind(this, origInstance, this._newMessageForUnlinkedBox.bind(this))
  ], cb);
};
