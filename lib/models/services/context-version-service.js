...
var UserWhitelist = require('models/mongo/userw-whitelist')
 ...
 */
ContextVersionService.isOwnerAllowed = function (contextVersion) {
  ...
  return UserWhitelist.findOneAsync({ lowerName: orgName.toLowerCase() })
    .then(function (whitelist) {
      if (!whitelist) {
        var orgNotFoundErr = new Error('Organization not found in whitelist')
