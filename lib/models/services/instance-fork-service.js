 ...
 */
InstanceForkService._forkNonRepoInstance = function (instance, masterInstanceShortHash, isolationId, sessionUser) {
  ...
  return Promise.try(function () {
    ...
    if (!masterInstanceShortHash) {
      throw new Error('_forkNonRepoInstance masterInstanceShortHash is required')
    }
    if (!isolationId) {
