 ...
 * @param {String}   instance.shortName
 * @param {String}   instance.shortHash
 * @param {Object[]} instance.aliases
 * @param {String}   instance.containerStartCommand
 * @param {String[]} instance.env
 * @param {Object}   instance.ipWhitelist
 * @param {Boolean=} instance.isTesting
 * @param {Boolean=} instance.isTestReporter
 * @param {Object}   instance.owner
 * @param {Object[]} instance.ports
...
InstanceForkService.createForkedInstanceBody = function (instance, opts) {
  ...
  if (opts.isolated) {
    ...
    defaultBody.name = InstanceForkService.generateIsolatedName(instance.shortHash, instance.name)
  } else if (opts.branch) {
 ...
 */
InstanceForkService.forkNonRepoInstance = function (instance, isolationId, sessionUser) {
  var log = InstanceForkService.logger.child({
