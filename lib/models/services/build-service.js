 ...
 * @throws   {Error}               When Mongo fails
 */
BuildService.findBuildAndAssert = function (id, sessionUser) {
  var log = BuildService.logger.child({
    method: 'findBuildAndAssert',
    id: id,
    sessionUser: sessionUser
  })
  log.info('findBuildAndAssert: call')
...
BuildService.buildBuild = function (buildId, data, sessionUser, domain) {
  ...
  return BuildService.findBuildAndAssert(buildId, sessionUser)
    .tap(function checkBuild (build) {
      if (build.completed) {
