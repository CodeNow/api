    ...
    .then(function (result) {
      ...
      return BuildService.createNewContextVersion(instance, pushInfo)
        ...
        .then(function (newContextVersion) {
          ...
          log.trace({
            contextVersionId: newContextVersion._id,
            triggeredActionName: triggeredActionName
          }, 'createClient')
          ...
          return Promise.fromCallback(function (callback) {
            ...
            // refetch because CV CHANGED
            return ContextVersion.findByIdAsync(newContextVersion._id)
