...
module.exports = class DockerComposeClusterService {
  ...
  static createClusterSibling (sessionUser, siblingComposeData) {
    const log = DockerComposeClusterService.log.child({
  ...
  /**
   * @param  {SessionUser} sessionUser
   * @param  {Object} composeData
   * @param  {String} composeData.name
   * @param  {Array<String>}  composeData.env
   * @param  {Array<Number>}  composeData.ports
   * @param  {String}  composeData.containerStartCommand
   * @param  {ObjectId} buildId
   * @return {Promise}
   * @resolves {Instance} newly created sibling instanceId
   */
  static _createSiblingInstance (sessionUser, composeData, buildId) {
    const instanceOpts = {
      build: buildId,
      env: composeData.env,
      ports: composeData.ports,
      containerStartCommand: composeData.containerStartCommand,
