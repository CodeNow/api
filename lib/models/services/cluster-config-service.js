...
module.exports = class ClusterConfigService {
  ...
  static _createInstance (sessionUser, parsedInstanceData, parentBuildId, testingOpts, masterInstance) {
    ...
    if (masterInstance.isolated) {
      // we need the name of the instance to contain the parent's shortHash with a --
      inputInstanceOpts.name = masterInstance.shortHash + '--' + inputInstanceOpts.name
    }
