...
module.exports = class ClusterConfigService {
   ...
   * @param {String}      parsedConfigData.build.buildDockerfilePath
   ...
   * @param {String}   instanceObj.config.build.buildDockerfilePath - Dockerfile path
  ...
  static _updateInstanceWithConfigs (sessionUser, instanceObj, orgInfo) {
    ...
    const newDockerfilePath = keypather.get(instanceObj, 'config.build.buildDockerfilePath')
