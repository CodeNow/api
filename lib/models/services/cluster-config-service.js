...
module.exports = class ClusterConfigService {
  ...
  static _createInstance (sessionUser, parsedInstanceData, parentBuildId, testingOpts, buildOpts) {
    ...
    const isMain = keypather.get(parsedInstanceData, 'metadata.isMain')
    const shouldNotAutoFork = isMain ? buildOpts.shouldNotAutoFork : true
    ...
    const defaultInstanceOpts = {
      ...
      shouldNotAutofork: shouldNotAutoFork !== undefined ? shouldNotAutoFork : true,
