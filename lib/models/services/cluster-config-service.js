...
module.exports = class ClusterConfigService {
   ...
   * @param {String}      parsedConfigData.code.commitish   - Commit or branch. Optional
  ...
  static _createContextVersion (sessionUser, contextId, orgInfo, repoName, parsedConfigData) {
    ...
    return InfraCodeVersionService.findBlankInfraCodeVersion()
      .then((parentInfaCodeVersion) => {
        ...
        const serviceRepoName = keypather.get(parsedConfigData, 'code.repo') || repoName
        return ContextVersion.createAppcodeVersion(sessionUser, serviceRepoName)
        .then((appCodeVersion) => {
