...
module.exports = class ClusterConfigService {
  ...
  static create (sessionUser, data) {
    ...
    const commitRef = 'master'
    return ClusterConfigService.fetchFileFromGithub(bigPoppaUser, repoFullName, filePath, commitRef)
      .then(parseInput => {
        return ClusterConfigService.parseComposeFileAndPopulateENVs(parseInput, repoFullName, clusterName, sessionUser, commitRef)
          .then(parsedCompose => {
   ...
   * @param {String} commitRef                - Name of the commit/branch/tag
   *
  ...
  static fetchFileFromGithub (bigPoppaUser, repoFullName, filePath, commitRef) {
    ...
    return github.getRepoContentAsync(repoFullName, filePath, commitRef)
      .then(fileContent => {
