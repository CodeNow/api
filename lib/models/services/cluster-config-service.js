...
module.exports = class ClusterConfigService {
  ...
  static _updateInstanceWithConfigs (sessionUser, instanceObj, buildOpts, ownerInfo) {
    ...
    return Promise.try(() => {
      ...
      // If this instance is the isolationMaster, don't look at the commit or branch
      const isIsolationMaster = instanceObj.instance.isIsolationGroupMaster
      const newCommitish = keypather.get(instanceObj.config, 'code.commitish')

      const hasCommitChanged = !isIsolationMaster && newCommitish &&
