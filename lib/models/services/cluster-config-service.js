...
module.exports = class ClusterConfigService {
  ...
  static delete (clusterId) {
    ...
    return AutoIsolationConfig.findByIdAndAssert(clusterId)
      ...
      .tap(() => {
        return InputClusterConfig.markAsDeleted(clusterId)
      })
      .tap(() => {
  ...
  static deleteAllICC (clusterId) {
    ...
    log.info('called')
    return InputClusterConfig.findSimilarActive(clusterId)
      .each((cluster) => rabbitMQ.deleteCluster({ cluster: { id: cluster._id } }))
  }
