...
module.exports = class ClusterConfigService {
  ...
  /**
   *
   * @param {Object[]} instanceObjectsWithConfigs
   * @param {String}   mainInstanceKey -
   * @returns
   * @private
   */
  static _getInstanceFromServicesByShortName (instanceObjectsWithConfigs, mainInstanceKey) {
    return instanceObjectsWithConfigs.find(instanceModels => {
