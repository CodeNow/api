...
/**
 * Populates the models and owner/created by in the instance and emits the right events
 * @param instance - Instance Object we are updating
 * @param userGithubId - Github ID we should use to populate models, if null uses instance.createdBy.github
