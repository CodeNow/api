 ...
 */
InstanceService.validateBody = function (body, requireBuild) {
  var schema = {
 ...
 */
InstanceService.createInstance = function (body, sessionUser) {
  body = pick(body, [
    'autoForked',
    'build',
    'env',
  ...
  return InstanceService.validateBody(body, true)
  ...
  .then(function (instance) {
    ...
    return Build.findByIdAsync(buildId)
      .then(function (build) {
        ...
        if (build && oldContextVersionId !== newContextVersionId && oldContextVersionId) {
          log.trace({
