...
InstanceService.createContainer = function (opts, cb) {
  ...
  async.waterfall([
    ...
    function (mongoData, cb) {
      ...
      var tasks = {}
      tasks[container] = InstanceService._createDockerContainer.bind(InstanceService, createOpts)
      tasks[recovery] = mongoData.contextVersion.handleRecovery.bind(mongoData.contextVersion)
