  ...
  return Promise.all([
    ClusterDataService.populateInstancesWithClusterInfo(instances, sessionUser)
      .each(function (instance) {
        log.trace({ instance }, 'each instance was populated')
      }),
    ...
    .then(function () {
      log.trace({
        instances
      }, 'all instances populated')
      return instances.map(function (instance) {
        log.trace({ instance }, 'populated instance')
        log.trace({ instanceJSON: instance.toJSON() }, 'populated instance json')
