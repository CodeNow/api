...
IsolationService.forkRepoChild = Promise.method(function (instanceId, masterInstanceShortHash, isolationId, sessionUser) {
  var logData = {
    tx: true,
  ...
  if (!exists(instanceId)) {
    throw new Error('forkRepoChild instanceId is required')
  }
