...
/**
 * Find instances that we want to kill
 * @param isolationId - ID of the isolation
 * @returns {Promise}
 * @resolves {[Instances]} Array of instances that we want to kill
 */
IsolationService.findInstancesToKill = function (isolationId) {
