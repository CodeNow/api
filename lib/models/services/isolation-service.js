...
IsolationService.updateDependenciesForIsolation = function (master, children) {
  ...
  return Promise.try(function () {
    ...
    .then(function () {
      // First, do master
      return IsolationService._updateDependenciesForInstanceAndChildren(master, children)
    })
    .then(function (filteredChildrenList) {
      ...
      return Promise.each(children, function (child) {
        ...
        return IsolationService._updateDependenciesForInstanceAndChildren(child, children)
      })
    })
    .return(children)
}
...
IsolationService.createIsolationAndEmitInstanceUpdates = Promise.method(function (isolationConfig, sessionUser) {
  ...
  return Isolation._validateCreateData(isolationConfig)
    ...
    .then(function (models) {
      return Promise.props({
        masterInstance: models.masterInstance,
        nonRepoChildren: IsolationService._updateDependenciesForIsolation(models.masterInstance, models.nonRepoChildren),
        repoChildren: IsolationService._updateDependenciesForIsolation(models.masterInstance, models.repoChildren)
      })
    })
    .then(function (models) {
      return Promise.all([
