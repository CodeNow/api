...
ContextService.emitBuildEventUpdates = function (buildId, forceInstanceCvUpdate) {
  return ContextVersion.findByBuildId(buildId)
    ...
    .then(function emitInstanceUpdate () {
      return InstanceService.emitInstanceUpdateByCvBuildId(buildId, 'update', forceInstanceCvUpdate)
    })
}
