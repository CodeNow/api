...
module.exports = class ClusterDataService {
  ...
  static populateInstanceWithClusterInfo (instance) {
    ...
    const instanceLookupId = instance.isolated ? keypather.get(instance, 'parent.toString()') : instanceId
        ...
        .then((clusters) => {
          ...
          instances.forEach(function (instance) {
            ...
            const instanceLookupId = instance.isolated ? 
              keypather.get(instance, 'parent.toString()') : keypather.get(instance, '_id.toString()')
