...
module.exports = class ClusterDataService {
  ...
  static makeClusterData (cluster, autoIsolationConfig) {
    const clusterConfigData = Object.assign({}, cluster.toJSON(), {
      masterInstanceId: autoIsolationConfig.instance
    })
  ...
  static populateInstanceWithClusterInfo (instance) {
    ...
    return AutoIsolationConfig.findActiveByAnyInstanceId(instanceId)
      .then((aig) => {
      ...
      .catch(Error, (err) => {
        log.error({ err }, 'couldnot populate instance with cluster data')
      })
  }
  ...
  static populateInstancesWithClusterInfo (instances, sessionUser) {
    ...
    return Promise.try(() => {
      ...
      .catch(Error, (err) => {
        log.error({ err }, 'couldnot populate instances with cluster data')
      })
    })
  }
}
