...
const UserService = module.exports = {
   ...
   * @param {String}   opts.githubUsername - Users name to search for
   * @param {String}   opts.githubOrgName  - Github Org's name to search for
   *
   * @resolves
   */
  findUsersByGithubOrgNameOrUsername: function (opts) {
