...
const UserService = module.exports = {
  ...
  createCompleteUser: function (userData) {
    var log = UserService.log.child({ method: 'UserService.createCompleteUser' })
    log.info({ userData }, 'UserService.createCompleteUser called')
    let githubId = userData.accounts.github.id
    let accessToken = userData.accounts.github.accessToken
    return Promise.all([
