...
const OrganizationService = module.exports = {
  ...
  ORG_FLAG_SCHEMA: joi.object({
    hasConfirmedSetup: joi.boolean().required()
   ...
   * @param {Object} opts.hasConfirmedSetup - the org has completed the setup
   *
  ...
  updateFlagsOnOrg: function (orgId, sessionUser, opts) {
    return joi.validateOrBoomAsync(opts, OrganizationService.ORG_FLAG_SCHEMA)
      ...
      .then(function () {
        return OrganizationService.updateById(orgId, {
          metadata: opts
        })
      })
      .tap(OrganizationService.checkOrg(orgId))
  }
}
