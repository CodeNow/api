...
const OrganizationService = module.exports = {
  ...
  updatePrivateRegistryOnOrgBySessionUser: function (sessionUser, bpOrgId, privateRegistryOptions) {
    ...
    return joi.validateOrBoomAsync(privateRegistryOptions, bpOrgId, updateSchema)
      .tap(() => {
        log.trace({
          privateRegistryUrl: updateSchema.url,
          privateRegistryUsername: updateSchema.username
      ...
      .tap(() => {
        ...
        return bigPoppaClient.updateOrganization(bpOrgId, {
          privateRegistryUrl: updateSchema.url,
          privateRegistryUsername: updateSchema.username,
          privateRegistryPassword: updateSchema.privateRegistryPassword
        })
      })
  }
}
