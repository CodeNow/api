...
var serializers = assignAndCompose(bunyan.stdSerializers, {
  ...
  build: pick(build, ['_id', 'contextVersions', 'owner', 'failed', 'successful', 'completed']),
  sessionUser:pick(user, ['_id', 'accounts.github.id', 'accounts.github.login', 'accounts.github.username']),
  ...
  contextVersion: pick(data, ['_id', 'build._id', 'build.dockerContainer', 'build.completed', 'build.started']),
