...
var logger = require('middlewares/logger')('key-generator');
require('loadenv')();
...
module.exports.start = function () {
  logger.log.info('keypair generator has started');
  var self = this;
  ...
  Keypair.getRemainingKeypairCount(function (err, count) {
    if (err) {
      ...
      async.whilst(
        ...
        function (err) {
          logger.log.info('done creating keys');
          cb(err);
        }
      );
    }
