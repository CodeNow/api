 ...
 */
function EmptyResponseError (methodName, message, data) {
  Error.call(this)
  this._setMessageAndData(methodName, message, data)
}
util.inherits(EmptyResponseError, Error)
 ...
 * @param {object} [data] Extra data to include with the error, optional.
 */
EmptyResponseError.prototype._setMessageAndData = function (methodName, message, data) {
 ...
 * @module ponos:errors
 */
module.exports = EmptyResponseError
