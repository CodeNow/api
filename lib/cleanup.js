var async, cleanupContainersNotIn, configs, containers, getOwners, hasRegisteredOwner, onFirstRun, request, users, _;
async = require('async');
...
getOwners = function (domain, containers, cb) {
...
cleanupContainersNotIn = function (domain, whitelist, cb) {
