...
var Worker = require('workers/organization.invoice.pay')
...
describe('Organization Invoice Pay Worker', function () {
    ...
    describe('worker', function () {
      it('should get the organizations github id and send a socket message', function (done) {
        Worker.task(testJob).asCallback(function (err) {
          ...
          sinon.assert.calledWith(messenger.messageRoom, 'org', testOrganization.githubId, { task: 'organization.invoice.pay' })
          done()
        })
      })
    })
