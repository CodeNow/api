...
describe('Auto Isolation Config Model Tests', function () {
  describe('markAsDeleted', function () {
    ...
    it('should call AutoIsolationConfig.findOneAndUpdateAsync', function (done) {
  ...
  describe('findOneActive', function () {
    ...
    it('should call AutoIsolationConfig.findOneAsync', function (done) {
  ...
  describe('findByIdAndAssert', function () {
    ...
    it('should call AutoIsolationConfig.findByIdAsync', function (done) {
